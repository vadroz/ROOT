...
// Submit OTB Planning
//==============================================================================
function sbmItmScan(iss)
{
  var url = null;
  url = "ScanTrfCtnLst.jsp?IssStr=" + iss
...
<table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Select Stores For Item Transfer</b><br>

      <table>
      <tr>
         <td>Issuing Store:</td><td><SELECT name="IssStr" class="Small"></SELECT></td>
      <tr>
      <tr>
