<%@ page import="java.util.*, java.text.*, payrollreports.PrActAvgVarAllStr"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=PrActAvgVarAllStr.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
    PrActAvgVarAllStr actvar = new PrActAvgVarAllStr(sFrom, sTo, sUser);
...
function switchOrigAllw()
{
   ...
   if (dispAllw == "block" && document.all.thPayLn1.colSpan <= 3){ dispCols('Pay', "block") }
...
<!-------------------------------------------------------------------->
      ...
      <table border=1 cellPadding="0" cellSpacing="0" >
        ...
        <tr>
          ...
          <th class="DataTable" id="thAvgLn2" colspan=8><span id="spOrig">Original<br>Budget</span><span id="spAlwBdg">Allowable<br>Budget</span></th>
          <th class="DataTable" id="thAvgLn2b" rowspan=3>&nbsp;</th>
          <th class="DataTable" id="thAvgLn2" colspan=8>Actual</th>
          <th class="DataTable" id="thAvgLn2b" rowspan=3>&nbsp;</th>
          <th class="DataTable" id="thAvgLn2" colspan=8>Var</th>

          <th class="DataTable" id="thPayLn2" colspan=8><span id="spOrig">Original<br>Budget</span><span id="spAlwBdg">Allowable<br>Budget</span></th>
          <th class="DataTable" id="thPayLn2b" rowspan=3>&nbsp;</th>
          <th class="DataTable" id="thPayLn2" colspan=8>Actual</th>
          <th class="DataTable" id="thPayLn2b" rowspan=3>&nbsp;</th>
          <th class="DataTable" id="thPayLn2" colspan=8>Var</th>
        ...
        <tr>
           ...
           <th class="DataTable" id="thAvgLn3" colspan=6>Hourly</th>
           ...
           <th class="DataTable" id="thPayLn3" colspan=6>Hourly</th>
           <th class="DataTable" rowspan=2>Total</th>
           <th class="DataTable" rowspan=2 id="thPayLn3">Slr</th>
           <th class="DataTable" id="thPayLn3" colspan=6>Hourly</th>
           <th class="DataTable" rowspan=2>Total</th>
           ...
           <th class="DataTable" id="colOrig" rowspan=2>Bk. Bld.</th>
     ...
     %>
        <!-- Store Details -->
          <tr class="DataTable">
          <td class="DataTable11" nowrap><span id="spOrig"><a href="PrActAvgVar.jsp?Store=<%=sStr[i]%>&StrNm=<%=sStrName[i]%>&From=BEGWEEK&To=<%=sTo%>" target="_blank"><%=sStr[i] + " - " + sStrName[i]%></a></span><span id="spAlwBdg"><%=sStr[i] + " - " + sStrName[i]%></span></th>
          ...
          <td class="DataTable2" id="colOrig" nowrap>&nbsp;$<%=sVaHrSlr%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaHrHrs%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaHrAvg%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaBkBld%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaOther%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaHrTotHrl%></td>
          <td class="DataTable2" id="colOrig" nowrap>$<%=sVaHrTotal%></td>
        </tr>
     <%}%>

     <!------------------------- Report Total --------------------------------->
     <%
        actvar.setRepWoBkBldTot();
        sBdgHrs = actvar.getBdgHrs();
        sActHrs = actvar.getActHrs();
        sVarHrs = actvar.getVarHrs();
        // payments
     ...
     <tr id="trOrig" class="DataTable5">
       <td class="DataTable11" nowrap>Grand Total W/O Bike Builders</td>
       <th class="DataTable">&nbsp;</th>
          <td class="DataTable2" id="tdBkpHrs" nowrap><%=sBdgSlrHrs%></td>
          <td class="DataTable2" id="tdBkpHrs" nowrap><%=sBdgHrlHrs%></td>
          <td class="DataTable2" nowrap><%=sBdgHrs%></td>
          <th class="DataTable" id="tdBkpHrs">&nbsp;</th>
          <td class="DataTable2" id="tdBkpHrs" nowrap>&nbsp;<%=sActSlrHrs%></td>
          <td class="DataTable2" id="tdBkpHrs" nowrap>&nbsp;<%=sActHrlHrs%></td>
          <td class="DataTable2" nowrap><%=sActHrs%></td>
          <th class="DataTable" id="tdBkpHrs">&nbsp;</th>
          <td class="DataTable2" id="tdBkpHrs" nowrap>&nbsp;<%=sSlrHrsVar%></td>
          <td class="DataTable2" id="tdBkpHrs" nowrap><%=sHlrHrsVar%></td>
          <td class="DataTable2" nowrap><%=sVarHrs%></td>
          <th class="DataTable">&nbsp;</th>

          <!-- Average Wage -->
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgSlrPay%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgPay%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgCom%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgLSpiff%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgMSpiff%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sBdgAvgOther%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>$<%=sBdgAvgHrlPay%></td>
          ...
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sAvgSlrVar%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sVarAvgPay%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sVarAvgCom%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sVarAvgLSpiff%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sVarAvgMSpiff%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>&nbsp;$<%=sVarAvgOther%></td>
          <td class="DataTable2" id="tdBkpAvg" nowrap>$<%=sAvgHrlVar%></td>
          <td class="DataTable2" nowrap>$<%=sVarAvgTotPay%></td>
          <th class="DataTable">&nbsp;</th>

          <!-- Payments $'s -->
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgSlrPay%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgPay%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgCom%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgLSpiff%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgMSpiff%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sBdgOther%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>$<%=sBdgHrlPay%></td>
          ...
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sSlrPayVar%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sVarPay%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sVarCom%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sVarLSpiff%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sVarMSpiff%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>&nbsp;$<%=sVarOther%></td>
          <td class="DataTable2" id="tdBkpPay" nowrap>$<%=sHrlPayVar%></td>
     ...
     <%
        ...
        sVhtPay = actvar.getVhtPay();
     %>
     <tr class="Divdr1"></td><td colspan=71>&nbsp;</td></tr>
     <tr class="Divdr1"></td><td colspan=71>&nbsp;</td></tr>
     <tr class="DataTable5">
