...
else
{
    ...
    if (sAction.equals("UPLOAD"))
    {
       ...
       volapi.getByGroup("RMAHEADER", "SASS");
       volapi.disconnect();

       // Item
       volapi = new EComVolAPI();
       volapi.getByGroup("RMAITEM", "SASS");
       volapi.disconnect();
       volapi = null;
    }
%>
...
function resubmit()
{
   var url = "EComUplRMA_Direct.jsp?&Action=UPLOAD";
...
{
  // return to main page
  window.location.href="EComUplRMA_Direct.jsp"
}
//==============================================================================
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - RMA (Headers and Items) Uploading (Directly to ISP)
        </B><br>
