...
function showBdgSchedVar(BdgHrs, SchHrs, HrsVar, PrcVar, GrpName, GrpBdgHrs, GrpSchHrs, GrpHrsVar)
{
  ...
  document.all.dvBdgVsSchedVar.style.pixelTop=95;
...
function sbmSubstitute(grp, grpname, oldemp, day, key)
{
   ...
   if(isEmpDaySelValid())
   {
      ...
      //alert(url)
      window.frame6.location.href = url;
   }
}
//==============================================================================
// validate Employee Day Selection
...
function EmpDayHrs.prototype.getKey(){ return this.key; }
//==============================================================================
...
function saveEmpEMail()
{
   ...
   window.frame5.location.href = url;
...
<!-------------------------------------------------------------------->
  <table border="0" width="100%" height="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="moccasin"><td ALIGN="center" VALIGN="TOP" colspan="3">
      <b>Weekly Schedule Summary(New Schedule)</b>
     </tr>
     <tr bgColor="moccasin">
     ...
     <tr bgColor="moccasin">
      ...
      <table class="DataTable" cellPadding="0" cellSpacing="0" id="tbSched">
         <tr>
           ...
           <th class="DataTable" rowspan="4" id="thTotal" colspan=2>Total</th>
         </tr>
         <tr>
           <%for(int i=0; i < 7; i++){%>
             <th class="DataTable" >
         ...
         <tr>
           <th class="DataTable1" colspan="3">Store-To-Do List</th>
           <%for(int i=0; i < 7; i++){%>
     ...
     <!-- ------------- Original Daily Sales Goals ---------------- -->
         <tr>
           ...
           <%}%>
           <th class="DataTable" rowspan=3>&nbsp;Avg&nbsp;<br>&nbsp;Hrs&nbsp;<th>
         </tr>
     <!-- --------------- Daily Sales Goals ---------------- -->
         <tr>
           <th class="DataTable1" colspan="3">
           ...
           <tr id="trDtl">
            ...
            <%for(int k=0; k < 7; k++)
             ...
             %>
              ...
              <td class="DataTable4"><%=sGrpAvgHrs[i][j]%></td)
           </tr>
       <%}%>
