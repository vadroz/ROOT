<%@ page import="payrollreports.StrDlyToDoList, java.util.*"%>
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=StrDlyToDoList.jsp&" + request.getQueryString());
   }
   else
   {
     String sUser = session.getAttribute("USER").toString();

     StrDlyToDoList schpay = new StrDlyToDoList(sStore, sDate, sUser);
...
<!-------------------------------------------------------------------->
    ...
    <table border="0" width="100%" height="100%">
      ...
      <br>Daily Goals and Assignment</b><br>
<!-------------------------------------------------------------------->
...
<!-------------------------------------------------------------------->
      <p style="text-align:left;">
        ...
        <a href="StrDlyToDoListSel.jsp"><font color="red" size="-1">Store/Date Selector</font></a>&#62;
         ...
         <%for(int i=0; i < iNumOfEmp - 2; i++ ){
             ...
             <tr>
                ...
                <td class="DataTable1" nowrap>
                   <a <%if(sMoved[i].equals("1")){%>style="color:red"<%}%> href="javascript: chgPosition('<%=sEmp[i]%>', '<%=sGrpNm[i]%>', '<%=sMoved[i]%>')">
