...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=StrPtyCashDayLogSel.jsp&APPL=" + sAppl);
   }
   else {
...
function validate()
{
   ...
   var date = document.all.Wkend.value;

   if (error) {alert(msg); }
   else { submit(str, date) }
}
//==============================================================================
// change action on submit
//==============================================================================
function submit(str, date){
   SbmString = "StrPtyCashLogSum.jsp?Str=" + str
	 + "&Date=" + date;         
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Store Petty Cash Reconciliation Log Entry - Selection
       </b><br><br>
