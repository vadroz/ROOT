...
{
   response.sendRedirect("SignOn1.jsp?TARGET=BdgVsSchActSel.jsp&APPL=" + sAppl);
}
else {
...
function dspDateSel()
{
	...
	if (ArrStr.length < 3){ rangeType = "Y"; }
	else
	{
	...
	// display/hide date type selection
	if(rangeType == "W")
	{
   		document.all.trWkSel.style.display = disp;
   		document.all.trYrSel.style.display = "none";   
	}
	if(rangeType == "Y")
	{
   		document.all.trWkSel.style.display = "none";
   		document.all.trYrSel.style.display = disp;   
	}
}
//==============================================================================
// populate date with yesterdate
...
function validate()
{
	...
	// store
   	...
   	if (error) {alert(msg); }
   	else { submit(selstr, rangeType, wkend, year) }
}
//==============================================================================
// change action on submit
//==============================================================================
function submit(str, rangeType, wkend, year)
{
	url = "BdgVsSchAct.jsp?Type=" + rangeType
	 + "&Wkend=" + wkend
	 + "&Year=" + year
	;
	for(var i=0; i < str.length; i++)
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Budget vs. Schedule or Actual Payroll - Selection
       </b><br><br>
      ...
      <!-- ============== Multiple Store selection ======================= -->
        <tr id="trMult">
         ...
         <%for(int i=0; i < iNumOfStr; i++){%>
                  <input class="Small" name="Str" onclick="dspDateSel()" type="checkbox" value="<%=sStr[i]%>"><%=sStr[i]%>&nbsp;
                  <%if(i > 0 && i % 14 == 0){%><br><%}%>
              <%}%>
              <%if(iNumOfStr > 1) {%>
      ...
      <TR id="trYrSel">
          <TD style="text-align:center;">Fiscal Year: <SELECT name="Year"></SELECT></TD>
      </TR>      
      <TR><td>&nbsp;</td></TR>
      <!-- =============================================================== -->
      <tr><td style="border-top: darkred solid 1px;">&nbsp;</td></tr>
