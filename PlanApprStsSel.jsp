<%@ page import=" agedanalysis.PlanSel"%>
<%
   //----------------------------------
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PlanApprStsSel.jsp&APPL=ALL");
   }
   else
   {
      ...
      if (sMode.equals("2"))
      {
         select = new PlanSel(request.getParameter("DIVISION"),
...
function chgStrSel(str)
{
  ...
  if(str.value=="ALL" && str.checked || str.value=="SAS" && str.checked || str.value=="SCH" && str.checked)
  {
  ...
  else if(str.value!="ALL" && str.value!="SAS" && str.value!="SCH")
  {
...
function setAction(target){
  ...
  if(target==0) action = "PlanApprStsSel.jsp"; // go to select class
  else if(target==1) action = "PlanApprStsLst.jsp"; // submit report
    ...
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD align=left colspan="3">
             <input name="STORE" type="checkbox" value="ALL" onclick="chgStrSel(this)" checked>Openned Stores&nbsp;&nbsp;
             <input name="STORE" type="checkbox" value="SAS" onclick="chgStrSel(this)" >Sun & Ski&nbsp;&nbsp;
             <input name="STORE" type="checkbox" value="SCH" onclick="chgStrSel(this)" >Ski Chalet&nbsp;&nbsp;<br>

             <%for(int i=0; i<iNumOfStr; i++) {%>
               <input name="STORE" type="checkbox" onclick="chgStrSel(this)" value="<%=sStr[i]%>"><%=sStr[i]%>&nbsp;&nbsp;
               <%if(i == 15 || i == 30 ||i == 45) {%><br><%}%>
             <%}%>
