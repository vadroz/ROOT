...
else  
{
   ...
   String [] sActPayAmtNc = bdgwk.getActPayAmtNc();
   ...
   // Budget Hours and Pay amounts - No commissions
   String [] sBdgHrsNc = bdgwk.getBdgHrsNc();
   String [] sBdgPayNc = bdgwk.getBdgPayNc();
   String [] sBdgAvgNc = bdgwk.getBdgAvgNc();
   String [] sBdgTmcHrsNc = bdgwk.getBdgTmcHrsNc();
   String [] sBdgTmcPayNc = bdgwk.getBdgTmcPayNc();
   ...
   String [] sPayBdgVarNc = bdgwk.getPayBdgVarNc();
   ...
   String [] sPayAllowedNc = bdgwk.getPayAllowedNc();
...
<style>body {background:ivory;font-family: Verdanda}
        ...
        th.DataTable00 { border: #efefef solid 1px; background: #fa9b17; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable01 { border: #efefef solid 1px;background:Coral; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable02 { border: #efefef solid 1px;background:charTReuse; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable03 { border: #efefef solid 1px;background:#46c7c7; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable04 { border: #efefef solid 1px;background:#fff380; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable05 { border: #efefef solid 1px; background:#f75d59; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }
        th.DataTable06 { border: #efefef solid 1px; background:khaki; padding-top:3px; padding-bottom:3px;
                       text-align:center; vertical-align:middle ;font-size:12px }

        th.DataTable1 { border: #efefef solid 1px; background: #fa9b17;padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable11 { border: #efefef solid 1px; background: coral ;padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable12 { border: #efefef solid 1px; background: charTReuse ;padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable13 { border: #efefef solid 1px; background: #46c7c7; padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable14 { border: #efefef solid 1px; background: #fff380; padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable15 { border: #efefef solid 1px; background: #f75d59; padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
                       text-align:left; vertical-align:top ;font-size:12px }
        th.DataTable16 { border: #efefef solid 1px; background: khaki; padding-left:3px; padding-right:3px; padding-top:3px; padding-bottom:3px;
        ...
        th.DataTable26 { background: #f75d59; padding-top:3px; padding-bottom:3px;
                       writing-mode: tb-rl; filter: flipv fliph; font-size:12px }
        th.DataTable27 { background: khaki; padding-top:3px; padding-bottom:3px;
                       writing-mode: tb-rl; filter: flipv fliph; font-size:12px }
                       
        th.rotate { border: #efefef groove 1px; background: #fa9b17; white-space: nowrap; font-size:12px;}
		th.rotate > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate > div > span { padding: 0px 0px; }
		
		th.rotate1 { border: #efefef groove 1px; background: Coral; white-space: nowrap; font-size:12px;}
		th.rotate1 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate1 > div > span { padding: 0px 0px; }
		
		th.rotate2 { border: #efefef groove 1px; background: #ccffcc; white-space: nowrap; font-size:12px;}
		th.rotate2 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate2 > div > span { padding: 0px 0px; }
		
		th.rotate3 { border: #efefef groove 1px; background: charTReuse; white-space: nowrap; font-size:12px;}
		th.rotate3 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate3 > div > span { padding: 0px 0px; }
		
		th.rotate4 { border: #efefef groove 1px; background: #46c7c7; white-space: nowrap; font-size:12px;}
		th.rotate4 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate4 > div > span { padding: 0px 0px; }
		
		th.rotate5 { border: #efefef groove 1px; background: #fff380; white-space: nowrap; font-size:12px;}
		th.rotate5 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate5 > div > span { padding: 0px 0px; }	
		
		th.rotate6 { border: #efefef groove 1px; background: #f75d59; white-space: nowrap; font-size:12px;}
		th.rotate6 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate6 > div > span { padding: 0px 0px; }
		
		th.rotate7 { border: #efefef groove 1px; background: khaki; white-space: nowrap; font-size:12px;}
		th.rotate7 > div { transform: translate( 0px, 0px) rotate(270deg); width: 40px;}
		th.rotate7 > div > span { padding: 0px 0px; }		
        ...
        th.DataTable32 { border-top: black solid 3px;  background:#E2F3ED; padding-top:3px; padding-bottom:3px; font-size:12px; text-align:left;}
        ...
        td.DataTable212 { border: #efefef solid 1px; background: tan; padding-top:3px; padding-bottom:3px; padding-left:3px;
                       padding-right:3px; text-align:right;  font-weight: bold}

        td.DataTable3 { border: #efefef solid 1px; background: black; font-size:12px }
        
        td.DataTable4 { padding-top:3px; padding-bottom:3px; padding-left:3px;
                       padding-right:3px; text-align:center; }
        td.DataTable5 { border: #efefef solid 1px; background: ivory; padding-top:3px; padding-bottom:3px; padding-left:3px;
                       padding-right:3px; text-align:center; }
        ...
        div.dvAbClc { position:absolute; visibility:hidden; background-attachment: scroll;
              border: black solid 2px; width:150px; background-color:LemonChiffon;
              text-align:center; font-size:10px}
...
function bodyLoad()
{
   setBoxclasses(["BoxName",  "BoxClose"], ["dvEmpList", "dvSlsGoal", "dvAbClc"]);
   doSelDate();
...
function setIEComaptable()
{
	...
	{		
		document.all.tabSales.className = "DataTable2";
		document.all.thVert.className = "DataTable21";
		document.all.thVert1.className = "DataTable22";
		document.all.thVert2.className = "DataTable23";
		document.all.thVert3.className = "DataTable24";
		document.all.thVert4.className = "DataTable25";
		document.all.thVert5.className = "DataTable26";
		document.all.thVert6.className = "DataTable27";
...
function showGrpBdg()
{
  ...
  var html = "<table border=0 width='100%' cellPadding=0 cellSpacing=0>"
   ...
   document.all.dvEmpList.innerHTML = html;
   document.all.dvEmpList.style.width = 500;
   document.all.dvEmpList.style.left= getLeftScreenPos() + 100;
   document.all.dvEmpList.style.top= getTopScreenPos() + 10;
   document.all.dvEmpList.style.visibility = "visible";
}
...
function chgSlsGoal(day)
{
  ...
  document.all.dvSlsGoal.style.left=10;
  document.all.dvSlsGoal.style.top=210;
...
function chgAbOvrHrs()
{
  ...
  document.all.dvEmpList.innerHTML=html
  document.all.dvEmpList.style.left=80;
  document.all.dvEmpList.style.top=210;
  document.all.dvEmpList.style.visibility="visible"
...
//==============================================================================
// close AB Hours calculation panel
//==============================================================================
function hidedvSlsGoal(){ document.all.dvSlsGoal.style.visibility="hidden" }
//==============================================================================
// close AB Hours calculation panel
//==============================================================================
function hidedvAbClc(){ document.all.dvAbClc.style.visibility="hidden" }
//==============================================================================
...
function displayHelp(text, obj)
{
   ...
   document.all.dvHelp.style.left= pos[0] - 200;
   document.all.dvHelp.style.top= pos[1] - 25;
...
function dspCalcFormulaHrsEarn(arg, bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff,
           ...
           actSls, origPlan, slsTrend, dayPass, alwBdgHrs, actSchdHrs, tag)
{
   ...
   document.all.dvSlsGoal.innerHTML=html
   document.all.dvSlsGoal.style.left=getLeftScreenPos() + 50;
   document.all.dvSlsGoal.style.top=getTopScreenPos() + 70;
   document.all.dvSlsGoal.style.visibility="visible"
...
function popCalcFormulaHrsEarn(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff, bdgPos, hrsEarned
         ...
         , origPlan, slsTrend, dayPass, alwBdgHrs, actSchdHrs, tag)
{
    ...
    var compToLine = "Less Original Sales Plan (Line 2)";
    var compToLine2 = " &nbsp; If Original Sales Plan (line 2) is greater than Sales Threshold,<br> &nbsp; then let this line B be equal to Original Sales Plan."
                    + "<br> &nbsp; If Original Sales Plan (line 2) is less than Sales Threshold,<br> &nbsp; then let this line B be equal to Sales Threshold.";
    var noCalcLine = "No hours are earned or lost due to: "
         + "<ul>"
    if (act <= slsThresh)
    {
      noCalcLine += "<li>Actual/Forecast Sales are equal to or below Sales Threshold</li>"
    }

    if (bdgHrs <= eval(BaseHrlyHrs))
    {
      noCalcLine += "<li>Original Budget Hours are equal to or below Base Hours</li>"
    }
    noCalcLine += "</ul>" ;
    ...
    if(plan < slsThresh)
    {
       ...
       compTo = BaseBdg;
       compToLine = "Less Sales Threshold";
    ...
    if(eval(bdgHrs) > eval(BaseHrlyHrs) && eval(bdgHrs) + eval(result11) < eval(BaseHrlyHrs))
    {
       result11 = eval(BaseHrlyHrs) - eval(bdgHrs);
    }
    ...
    html += "<tr class='DataTable3'>"
                + "<th class='DataTable322' colspan=2 nowrap > &nbsp; Memo: Original Sales Plan (line 2)</th>"
                + "<th class='DataTable322' nowrap >&nbsp;</th>"
                + "<th class='DataTable322' nowrap >$" + origPlan + "</th>"
                + "<th class='DataTable322' nowrap >&nbsp;</th>"
             + "</tr>"

    html += "<tr class='DataTable3'>"
                + "<th class='DataTable322' colspan=2 nowrap > &nbsp; Memo: Actual/Forecast Sales (line 6)</th>"
                + "<th class='DataTable322' nowrap >&nbsp;</th>"
                + "<th class='DataTable322' nowrap >$" + actSls + "</th>"
                + "<th class='DataTable322' nowrap >&nbsp;</th>"
             + "</tr>"


    html += "<tr class='DataTable3'>"
           + "<th class='DataTable322' colspan=5 nowrap>"
              + "<div style='background: cornsilk; border-top: red solid 2px; border-bottom: red solid 2px; font-size:10px;font-style:italic'>"
                  + "No hours will be earned or lost if Actual/Forecast Sales are equal to or less than the<br>Sales Threshold."
              + "</div>"
           + "</th>"
        + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable32' nowrap colspan=2> &nbsp; Memo: Base Hours (hourly only)</th>"
           + "<th class='DataTable32' nowrap >&nbsp;</td>"
           + "<th class='DataTable32' nowrap >" + BaseHrlyHrs + "</td>"
           + "<th class='DataTable32' nowrap >&nbsp;</td>"
          + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable322' nowrap colspan=2> &nbsp; Memo: Original Budget Hours (line 9)</th>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
           + "<th class='DataTable322' nowrap >" + bdgTotHrs + "</td>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
          + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable322' nowrap colspan=2> &nbsp; Memo: Allowable Budget Hours (line 11)</th>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
           + "<th class='DataTable322' nowrap >" + alwBdgHrs + "</td>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
          + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable322' nowrap colspan=2> &nbsp; Memo: Actual/Scheduled Hours (line 14)</th>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
           + "<th class='DataTable322' nowrap >" + actSchdHrs + "</td>"
           + "<th class='DataTable322' nowrap >&nbsp;</td>"
          + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable321' colspan=5 nowrap>"
             + "<div style='background: cornsilk; border-top: red solid 2px; border-bottom: red solid 2px; font-size:10px;font-style:italic'>"
               + "No hours will be lost if the Original Budget Hours are equal to or below Base<br>Hours."
             + "</div>"
           + "</th>"
        + "</tr>"

    if((act < slsThresh || bdgHrs <= eval(BaseHrlyHrs)) && result11 < 0  )
    {
       html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
    ...
    else if(abHrs == 0)
    {
       html += "<tr class='DataTable3'>"
        ...
        /*html += "<tr class='DataTable3'>"
           + "<th class='DataTable31' colspan=5 nowrap>"
               + "<div style='background: cornsilk; border-top: red solid 2px; border-bottom: red solid 2px; font-size:10px;font-style:italic'>"
               + "Maximum amount of increase(decrease) in Budget Hours<br>"
               + "in one week is 40 housr.</div>"
        */
     }
...
//==============================================================================
// AB Average Calculation
//==============================================================================
function dspCalcABAvg(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff,
           bdgPos, hrsEarned, hsvEarned, slsCommRatio, slsCommRate, lSpiff, pSpiff, slsPayrollPrc,
           actSls, origPlan, slsTrend, dayPass, alwBdgHrs, actSchdHrs, tag)
{
   var wkday = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun", "Total"];
   var hdr = "Allowable Budget Average Hourly Rate";
   var html = "<table border=0 width='100%' cellPadding=0 cellSpacing=0 id='tblHrsEarn'>"
     + "<tr>"
       + "<td class='BoxName' nowrap>" + hdr + "</td>"
       + "<td class='BoxClose' valign=top>"
         +  "<img src='CloseButton.bmp' onclick='javascript: hidedvAbClc();' alt='Close'>"
       + "</td></tr>"
       + "<tr><td class='Prompt' colspan=2 id='dvHrsEarn'>"
          + "<div id='dvCals' style='overflow:auto;'>"
            + popCalcABAvg(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff, bdgPos,
                  hrsEarned, hsvEarned, slsCommRatio, slsCommRate, lSpiff, pSpiff, slsPayrollPrc,
                  actSls, origPlan, slsTrend, dayPass, alwBdgHrs, actSchdHrs, tag)
          + "</div>"
       + "</td></tr>"
   ...
   document.all.dvAbClc.innerHTML=html
   document.all.dvAbClc.style.left=getLeftScreenPos() + 300;
   document.all.dvAbClc.style.top=getTopScreenPos() + 70;
   document.all.dvAbClc.style.visibility="visible"
   window.location.hash=tag;
}
//==============================================================================
// populate Hours earhed calculation formulas panel
//==============================================================================
function popCalcABAvg(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff, bdgPos, hrsEarned
         , hsvEarned, slsCommRatio, slsCommRate, lSpiff, pSpiff, slsPayrollPrc, actSls
         , origPlan, slsTrend, dayPass, alwBdgHrs, actSchdHrs, tag)
{
    var act = removeComas(actSls);
    ...
    var incSls = (slsDiff * eval(slsCommRatio)/100 * eval(slsCommRate)/100).toFixed(0)
    var incRate = (incSls / bdgHrs).toFixed(2);
    var spiff = eval(GrpBdgPayLSpiff[GrpBdgPayLSpiff.length-1]) + eval(GrpBdgPayMSpiff[GrpBdgPayMSpiff.length-1]);
    var slsDiffPrc = (slsDiff / plan * 100).toFixed(1);
    var incSpiff = (slsDiff / plan * spiff).toFixed(0);
    var incAvgRate = (incSpiff / bdgHrs).toFixed(2);
    var abRate = (eval(bdgAvgRate) + eval(incAvgRate) + eval(incRate)).toFixed(2);
    ...
    html += "<tr class='DataTable3'>"
                + "<th class='DataTable32' colspan=2 nowrap > &nbsp; Original Budget Rate</th>"
                + "<th class='DataTable32' nowrap >&nbsp;</th>"
                + "<th class='DataTable32' nowrap >$" + bdgAvgRate + "</th>"
                + "<th class='DataTable32' nowrap >&nbsp;</th>"
             + "</tr>"

    html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; A. &nbsp; </th>"
           + "<th class='DataTable311' nowrap > Commissions - </th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"
       ...
       html += "<tr class='DataTable3'>"
        ...
        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Less Original Sales Plan (line 2)</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + origPlan + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap colspan=2>&nbsp;</th>"
           + "<td class='DataTable' nowrap>&nbsp;</th>"
           + "<td class='DataTable' nowrap>&nbsp;</th>"
           + "<td class='DataTable' nowrap>&nbsp;</th>"
        + "</tr>"
        ...
        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Increase(decrease) in sales</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + addCommas(slsDiff) + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Times sales goal</th>"
           + "<td class='DataTable' nowrap >x</td>"
           + "<td class='DataTable' nowrap >" + (eval(slsCommRatio)).toFixed(0) + "%</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Times commission %</th>"
           + "<td class='DataTable' nowrap >x</td>"
           + "<td class='DataTable' nowrap style='border-bottom: black solid 1px;'>" + (eval(slsCommRate)).toFixed(0) + "%</td>"
           + "<td class='DataTable' nowrap style='border-bottom: black solid 1px;'>&nbsp;</td>"
        + "</tr>"
        ...
        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Increase(decrease) in commissions</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + incSls + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Divided by original budget hours</th>"
           + "<td class='DataTable' nowrap >/</td>"
           + "<td class='DataTable' nowrap >" + bdgTotHrs + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Increase in hourly rate due to commissions%</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;'>$" + incRate + "</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap > &nbsp; B. &nbsp; </th>"
           + "<th class='DataTable31' nowrap > Spiffs - </th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Original budgeted spiffs(labor + paid)</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + spiff + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; % increase in sales"
             + "<br> &nbsp; (Actual/Forcast sales vs. Original sales plan)"
           + "</th>"
           + "<td class='DataTable' nowrap >x</td>"
           + "<td class='DataTable' nowrap >" + slsDiffPrc + "%</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; Increase in spiffs</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;'>$" + incSpiff + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"
        ...
        html += "<tr class='DataTable3'>"
           + "<th class='DataTable311' nowrap > &nbsp; &nbsp; </th>"
           + "<th class='DataTable311' nowrap > &nbsp; % Increase in hourly rate due to spiffs</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;'>" + incAvgRate + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap > &nbsp; C. &nbsp; </th>"
           + "<th class='DataTable31' nowrap > &nbsp; Allowable budget Average Hourly Rate</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;'>$" + abRate + "</td>"
           + "<td class='DataTable'>&nbsp;</td>"
        + "</tr>"
...
function dspEarnOnBase(bdgHrs, hrsEarnedOnBased)
{
   ...
   document.all.dvSlsGoal.innerHTML=html
   document.all.dvSlsGoal.style.left=getLeftScreenPos() + 100;
   document.all.dvSlsGoal.style.top=getTopScreenPos() + 200;
   document.all.dvSlsGoal.style.visibility="visible"
}
//==============================================================================
...
function popSlrReserv(baseDt, baseHrs, currHrs, reserved, nosalary, tmchrs, sickhrs)
{
    ...
    var html = "<table border=0 cellPadding='0' cellSpacing='0' width='100%'>"
        ...
        + "</tr>"
        + "<tr class='DataTable3'>"
           + "<td class='DataTable1' nowrap >Difference (in days)</td>"
           + "<td class='DataTable1' nowrap >=</td>"
...
<div id="dvAbClc" class="dvAbClc"></div>
...
<!-------------------------------------------------------------------->
      ...
      <table border=0 cellPadding="0" cellSpacing="0" >
        <tr>
          <td class="DataTable4" rowspan=14></td>
     ...
     <tr class="DataTable">
        <th class="rotate" rowspan=10 id="tabSales"><div><span>Sales</span></div></th>
        ...
        <%}%>
        <td class="DataTable5" id="tdFold"></td>
     </tr>
     <!-------------------- Sales Plan ---------------------------------------->
     <tr class="DataTable">
     ...
     <!----------------------- Budget Hours ----------------------------------->
     <tr class="DataTable">
        <th class="rotate2" id="thVert" rowspan=23 nowrap><div><span>Hourly Employee Only &nbsp; &nbsp<br>(Excludes Holiday, Sick, Vacation and TMC.)</span></div></th>
        <th class="rotate1" id="thVert1" rowspan=8><div><span>P/R Hours</span></div></th>
     ...
     <!-- tr class="DataTable" -->
        ...
        <%for(int i=0; i < 8; i++){%>
           <td  id="tdFold" class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">
              <%if(i==7){%><a href="javascript: dspCalcFormulaHrsEarn('<%=i%>','<%=sBdgHrs[7]%>','<%=sBdgPay[7]%>', '<%=sBdgAvg[7]%>', '<%=sActSlsDiff[7]%>', '<%=sBdgPayOfSls[7]%>', '<%=sHrsEarned[i]%>', '<%=sHrsEarnedNoSlry[7]%>', '<%=sSlsCommRatio%>', '<%=sSlsCommRate%>', '<%=sLSpiff%>', '<%=sPSpiff%>', '<%=sSlsPayrollPrc%>', '<%=sActSls[7]%>', '<%=sSlsPlan[7]%>', '<%=sAltSlsPlan[7]%>','<%=iNumOfPassDays%>', '<%=sHrsAllowed[7]%>','<%=sActPayHrs[7]%>','alwhrs')">
     ...
     <tr class="DataTable">
        <th class="DataTable11" id="tdFold">Hours Earned (Based on Salaried Employees on V,H or TMC)&nbsp;</th>
        <%for(int i=0; i < 8; i++){%>
           <td  id="tdFold" class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">
     ...
     <tr class="DataTable">
        <th class="rotate3" id="thVert2" rowspan=4><div><span>P/R $'s</span></div></th>
     ...
     <!------------------------ Average Hourly Rate --------------------------->
     <tr class="DataTable">
        <th class="rotate4" id="thVert3" rowspan=3><div><span>Hourly<br>Rate</span></div></th>
     ...
     <tr class="DataTable">
        ...
        <td class="DataTable21">
          <a href="javascript: dspCalcABAvg('<%=sBdgHrs[7]%>','<%=sBdgPay[7]%>', '<%=sBdgAvg[7]%>', '<%=sActSlsDiff[7]%>', '<%=sBdgPayOfSls[7]%>', '<%=sHrsEarned[7]%>', '<%=sHrsEarnedNoSlry[7]%>', '<%=sSlsCommRatio%>', '<%=sSlsCommRate%>', '<%=sLSpiff%>', '<%=sPSpiff%>', '<%=sSlsPayrollPrc%>', '<%=sActSls[7]%>', '<%=sSlsPlan[7]%>', '<%=sAltSlsPlan[7]%>','<%=iNumOfPassDays%>', '<%=sHrsAllowed[7]%>','<%=sActPayHrs[7]%>','alwhrs')">
     ...
     <tr class="DataTable">
        <th class="rotate5"  id="thVert4" rowspan=5><div><span>Variance</span></div></th>
     ...
     <tr class="DataTable">
        <th rowspan=6></th>
        <th class="rotate6" id="thVert5" rowspan=6><div><span>TMC</span></div></th>
     ...
     <!--------------- AB -  not include Sales Commissions ---------------->
     ...
     <tr class="DataTable">
        <th rowspan=4></th>
        <th class="rotate7" id="thVert6" rowspan=4><div><span>PR$ - No Commission</span></div></th>
        <th class="DataTable06">15a</th>
        <th class="DataTable16">Original Payroll Budget Dollars - exclude Commissions</th>
        <%for(int i=0; i < 8; i++){%>
            <td class="DataTable2">$<%=sBdgPayNc[i]%></td>
        <%}%>
        <td class="DataTable2" rowspan=6></td>
     </tr>
     
     <tr class="DataTable">
        <th class="DataTable06">16a</th>
        <th class="DataTable16">Allowable Budget Dollars - exclude Commissions</th>
        <%for(int i=0; i < 8; i++){%>
           <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">$<%=sPayAllowedNc[i]%></td>
        <%}%>
        <td class="DataTable2"></td>
     </tr>
     
     <tr class="DataTable">
        <th class="DataTable06">17a</th>
        <th class="DataTable16">Actual / Scheduled Payroll $ - exclude Commissions</th>
        <%for(int i=0; i < 8; i++){%>
           <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">$<%=sActPayAmtNc[i]%></td>
        <%}%>
        <td class="DataTable2"></td>
     </tr>
     
     <tr class="DataTable">
        <th class="DataTable06">22a</th>
        <th class="DataTable16">Actual / Scheduled Dollars +/- Allowable Budget Dollars - exclude Commissions</th>
        <%for(int i=0; i < 8; i++){%>
           <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%} else if(i==7 && sPayBdgVarNc[i].indexOf("-") >= 0){%>g<%} else if(i==7){%>r<%}%>">$<%=sPayBdgVarNc[i]%></td>
        <%}%>
        <td class="DataTable2"></td>
     </tr>
