<%@ page import="java.util.*, java.text.*, payrollreports.BfdgSchActMn"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=BfdgSchActMn.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
   ...
   BfdgSchActMn bdgwk = new BfdgSchActMn(sStore, sYear, sMonth, sUser);
...
<!-------------------------------------------------------------------->
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Allowable Budget Review (Monthly) (New Schedule)
...
<!------------------------- Payroll Budget Dollars ----------------------->
     ...
     <tr class="DataTable">
       <td class="DataTable" rowspan=6></td>
        ...
        <%}%>
        <td class="DataTable" rowspan=6 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2"><%=sTmcHrsSch[i]%></td>
        <%}%>
     </tr>
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2"><%=sTmcHrsAct[i]%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2">$<%=sTmcPaySch[i]%></td>
        <%}%>
     </tr>
     <tr class="DataTable">
        <th class="DataTable05">4b</th>
        <th class="DataTable15">Hours Payrol $'s/Actual - TMC</th>
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2">$<%=sTmcPayAct[i]%></td>
        <%}%>
     </tr>
