<%@ page import="ecommerce.EComVolAPIProd"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplOrd_Direct.jsp");
}
else
{
...
function resubmit()
{
   var url = "EComUplOrd_Direct.jsp?&Action=UPLOAD";
...
{
  // return to main page
  window.location.href="EComUplOrd_Direct.jsp"
}
//==============================================================================
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - Order Uploading (Directly to ISP)
        </B><br>
