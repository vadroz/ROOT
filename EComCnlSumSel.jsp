...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=EComCnlSumSel.jsp&APPL=ALL");
   }
   else
   {
...
function doSelDate()
{
	...
	var date = new Date(new Date() - 365 * 86400000);
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>ECOM Summary for Selected Status - Selection</B>
        <br>
