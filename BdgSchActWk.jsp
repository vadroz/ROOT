<%@ page import="java.util.*, java.text.*, payrollreports.BdgSchActWk"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=BdgSchActWk.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
     ...
     if(!bStrAlwed){ response.sendRedirect("BdgSchActWkSel.jsp"); }


   BdgSchActWk bdgwk = new BdgSchActWk(sStore, sWkend, sUser);
   ...
   boolean bAvOvrHrsAllowed = sUser.equals("mparker") || sUser.equals("vrozen");
%>
...
{
  var panel = "<table border=1 id='tbBdgGrp' width='100%' cellPadding='0' cellSpacing='0'>";
  panel += "<tr class='DataTable2'>"
             + "<th class='DataTable3' rowspan=2 nowrap>Group</th>"
  ...
  panel += "<tr><td class='Prompt1' colspan=16>"
        + "<button onClick='hidePanel();' class='Small'>Close</button>&nbsp; &nbsp;"
        + "<button onClick='printTblContent(&#34;dvEmpList&#34;);' class='Small'>Print</button></td></tr>"
...
//==============================================================================
function dspCalcFormula(arg, bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff,
           ...
           actSls, origPlan, tag)
{
   ...
   var hdr = "Hours Earned. " + wkday[arg]
     + " &nbsp; <button class='Small' onclick='openPrintView()'>Print</button>";
     ...
     + "<tr>"
       ...
       + "<tr><td class='Prompt' colspan=2 id='dvHrsEarn'>"
          + "<div id='dvCals' style='overflow:auto;'>"
            + popCalcFormula(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff, bdgPos,
   ...
   document.all.dvCals.style.height = 500;
...
//==============================================================================
function popCalcFormula(bdgTotHrs, bdgTotPay, bdgAvgRate, totSlsDiff, bdgPos, hrsEarned,
         hsvEarned, slsCommRatio, slsCommRate, lSpiff, pSpiff, slsPayrollPrc, actSls, origPlan,tag)
{
    ...
    var result31 = (eval(result3) + eval(result6)) + " ";

    var result7 = clcRes6(result6, bdgTotHrs, 2);
    var result8 = clcRes3(result7, bdgAvgRate, '0', 2);
    //var result9 = clcRes6(result3, result8, 0);
    var result9 = clcRes6(result31, result8, 0);

    var html = "<div id='divAbCalc'>"
             + "<table border=0 cellPadding='0' cellSpacing='0' width='100%' id='tbAbCalc'>"
    if(abHrs == 0)
    {
        html += "<tr class='DataTable3'><th class='DataTable5' style='border:#FCECE5 solid 2px' colspan=4>Calculation of Allowable Budget Dollars:</th></tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >Original Payroll Budget Dollars (line 15) </th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >$" + bdgTotPay + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap>"
             + "Add(Subtract) Dollars due to increase(decrease) in Actual/Forcast Sales:"
           + "</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; Actual Sales</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + act + "</td>"
        ...
        if(plan >= slsThresh)
        {
           html += "<tr class='DataTable3'>"
                + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; Plan Sales</th>"
                + "<td class='DataTable' nowrap >-</td>"
                + "<td class='DataTable' nowrap >$" + plan + "</td>"
                + "<td class='DataTable2' nowrap >&nbsp;</td>"
             + "</tr>"
        }
        else
        {
           html += "<tr class='DataTable3'>"
                + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; Sales Threshold</th>"
                + "<td class='DataTable' nowrap >-</td>"
                + "<td class='DataTable' nowrap >$" + BaseBdg + "</td>"
                + "<td class='DataTable2' nowrap >&nbsp;</td>"
             + "</tr>"
        }

        html += "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; (1) Increase(decrease) in sales</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;$" + slsDiff + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Divided by 2 </th>"
           + "<td class='DataTable' nowrap >:</td>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Increase(decrease) in Budget Dollars</th>"
           + "<td class='DataTable' nowrap >=</td>"
           + "<td class='DataTable2' nowrap style='border-top: black solid 1px;' >&nbsp;</td>"
           + "<td class='DataTable2' nowrap style='border-top: black solid 1px;' >$" + result1 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; (2) Increase due to HSV # hours</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >" + hsvEarned + "</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Times Original Budgeted Average Hourly Rate (line 18)</th>"
           + "<td class='DataTable'  nowrap >*</td>"
        ...
        + "<tr class='DataTable3'>"
           ...
           + "<td class='DataTable' nowrap >=</td>"
           + "<td class='DataTable2' nowrap style='border-top: black solid 1px;' >&nbsp;</td>"
           + "<td class='DataTable2' nowrap style='border-top: black solid 1px;' >$" + result2 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; (3) Increase due to increase(decrease) in sales</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; commission $'s and Spiff $'s (see bellow calculation)</th>"
           + "<td class='DataTable'  nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >$" + result6 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable32' nowrap >Allowable Budget Dollars</th>"
           + "<td class='DataTable' nowrap >=</td>"
           + "<td class='DataTable' nowrap style='border-top: black solid 1px;' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap style='color:darkred; border-top: black solid 1px;' nowrap ><a name='alwdlr'>$" + result31 + "</a></td>"
        + "</tr>"

        + "<tr class='DataTable3'><th class='DataTable5' style='border:#FCECE5 solid 2px' colspan=4>Calculation of Allowable Budget Average Hourly Rate:</th></tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >I. Calculation of increase(decrease) in Payroll $'s</th>"
           + "<td class='DataTable'  nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; (1) Calculation of increase(decrease) in Sales Commission $'s</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           ...
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >$" + totSlsDiff + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Times Sales Commission Ratio</th>"
           + "<td class='DataTable' nowrap >*</td>"
           + "<td class='DataTable2' nowrap >" + slsCommRatio + "%</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Times Commission Rate</th>"
           + "<td class='DataTable' nowrap >*</td>"
           + "<td class='DataTable2' nowrap >" + slsCommRate + "%</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Increase(decrease) in Sales Commission $'s</th>"
           + "<td class='DataTable' nowrap>=</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap>&nbsp;</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap >$" + result4 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; (2) Calculation of increase(decrease) in Spiff $'s</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Original Labor Spiff</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >$" + lSpiff + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Original Paid Spiff</th>"
           + "<td class='DataTable' nowrap >+</td>"
           + "<td class='DataTable2' nowrap >$" + pSpiff + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Times increase(decrease) in sales (line 7)</th>"
           + "<td class='DataTable' nowrap >*</td>"
           + "<td class='DataTable2' nowrap >" + slsPayrollPrc + "%</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Increase(decrease) in Spiff $'s</th>"
           + "<td class='DataTable' nowrap>=</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap>&nbsp;</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap >$" + result5 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Total increase(decrease) in payroll $'s</th>"
           + "<td class='DataTable' nowrap>=</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap>&nbsp;</td>"
           + "<td class='DataTable2' style='border-top: black solid 1px;' nowrap >$" + result6 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >II. Divided By Original Budget Hours</th>"
           + "<td class='DataTable' nowrap >:</td>"
           + "<td class='DataTable2' nowrap >" + bdgTotHrs + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >III. Increase(decrease) in Average Wage</th>"
           + "<td class='DataTable' nowrap >=</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >$" + result7 + "</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >IV. Add Original Budget Average Hourly Rate (line 18)</th>"
           + "<td class='DataTable' nowrap >+</td>"
           + "<td class='DataTable2' nowrap >$" + bdgAvgRate + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"
        ...
        + "<tr class='DataTable3'>"
           + "<th class='DataTable32' nowrap >V. Allowable Budgeted Average Hourly Rate</th>"
           + "<td class='DataTable' nowrap >=</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' style='color:darkred;' nowrap ><a name='alwavg'>" + result8 + "</a></td>"
        + "</tr>"

        + "<tr class='DataTable3'><th class='DataTable5'  style='border:#FCECE5 solid 2px' colspan=4>Calculation of Allowable Budget Hours:</th></tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >Allowable Budget Dollars</th>"
           + "<td class='DataTable'  nowrap >&nbsp;</td>"
           + "<td class='DataTable2'  nowrap >$" + result3 + "</td>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >&nbsp; &nbsp; Divided Allowable Budget Average Hourly Rate</th>"
           + "<td class='DataTable' nowrap >:</td>"
           + "<td class='DataTable2' nowrap >$" + result8 + "</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        + "</tr>"

        + "<tr class='DataTable3'>"
           + "<th class='DataTable32' style='border-bottom:blue solid 2px' nowrap >Allowable Budget Hours</th>"
           + "<td class='DataTable' style='border-bottom:blue solid 2px' nowrap >=</td>"
           + "<td class='DataTable2' style='border-bottom:blue solid 2px' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' style='color:darkred; border-bottom:blue solid 2px' nowrap ><a name='alwhrs'>" + result9 + "</a></td>"
        + "</tr>"
        }
        // override hours is not 0
        else
        {
           html += "<tr class='DataTable3'>"
                   + "<th class='DataTable32' style='border-bottom:blue solid 2px' nowrap >Allowable Budget Hours</th>"
                   + "<td class='DataTable' style='border-bottom:blue solid 2px' nowrap >&nbsp;</td>"
                   + "<td class='DataTable2' style='border-bottom:blue solid 2px' nowrap >&nbsp;</td>"
                   + "<td class='DataTable2' style='color:darkred; border-bottom:blue solid 2px' nowrap ><a name='alwhrs'>" + AbOvrHrs + "</a></td>"
                 + "</tr>"
                 + "<tr class='DataTable3'>"
                     + "<th class='DataTable32' nowrap >V. Allowable Budgeted Average Hourly Rate</th>"
                     + "<td class='DataTable' nowrap >&nbsp;</td>"
                     + "<td class='DataTable2' nowrap >&nbsp;</td>"
                     + "<td class='DataTable2' style='color:darkred;' nowrap ><a name='alwavg'>$" + bdgAvgRate + "</a></td>"
                  + "</tr>"
                  + "<tr class='DataTable3'>"
                     + "<th class='DataTable32' nowrap >Allowable Budget Dollars</th>"
                     + "<td class='DataTable' nowrap >=</td>"
                     + "<td class='DataTable' nowrap style='border-top: black solid 1px;' nowrap >&nbsp;</td>"
                     + "<td class='DataTable2' nowrap style='color:darkred; border-top: black solid 1px;' nowrap ><a name='alwdlr'>$" + result3 + "</a></td>"
                  + "</tr>"
        }


        html += "<tr class='DataTable3'>"
           + "<td colspan=4 nowrap style='border-top: red solid 2px; border-bottom: red solid 2px; font-size:10px'>"             + "Note: No hours will be lost if the store is operating at or below base hours for the week.<br>"
             + "No hours will be earned if actual sales are equal to or less than the sales threshold per"
             + " the base schedule."
           + "</td>"
        + "</tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' style='border-top:blue solid 2px'  nowrap ><u>From Base Schedule</u></th>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable' style='border-top:blue solid 2px' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' style='border-top:blue solid 2px' nowrap >&nbsp;</td>"
        + "</tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' nowrap >Base Hours (hourly only)</th>"
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
        ...
        + "<tr class='DataTable3'>"
           ...
           + "<td class='DataTable' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >&nbsp;</td>"
           + "<td class='DataTable2' nowrap >$" + BaseBdg + "</td>"
        + "</tr>"
   html += "</table>"
      + "</div>"
...
//==============================================================================
function dispSlrReserv(baseDt, baseHrs, currHrs, reserved)
{
   ...
   var html = "<table border=0 width='100%' cellPadding=0 cellSpacing=0>"
     + "<tr>"
       ...
       + "</td></tr>"
        + "<tr><td class='Prompt' colspan=2>"
          + popSlrReserv(baseDt, baseHrs, currHrs, reserved)
       + "</td></tr>"
     + "</table>"
...
// populate Hours earhed calculation formulas panel
//==============================================================================
function popSlrReserv(baseDt, baseHrs, currHrs, reserved)
{
    ...
    var html = "<table border=0 cellPadding='0' cellSpacing='0' width='100%'>"
        ...
        + "</tr>"
        + "<tr class='DataTable3'>"
           + "<th class='DataTable31' colspan=3><a href='PrWkSched.jsp?STORE=<%=sStore%>&STRNAME=<%=sStrName.trim()%>&MONBEG=01/04/2099&WEEKEND=" + baseDt + "' target='_blank'>Base Schedule</a>"
           + " &nbsp; &nbsp; &nbsp; <a href='PrWkSched.jsp?STORE=<%=sStore%>&STRNAME=<%=sStrName.trim()%>&MONBEG=<%=sWkend%>&WEEKEND=<%=sWkend%>' target='_blank'>Selected Week Schedule</a></th>"
...
{
   var MyWindowName = "Allowable_Budget_Calculations";
   var MyWindowOptions =
    "left=20, top=20, width=800,height=600, toolbar=yes, location=yes, directories=yes, status=yes, scrollbars=yes, menubar=yes, scrollbars=1, resizable=yes";

   var html = document.all.divAbCalc.innerHTML;
   window_calc = window.open("", MyWindowName, MyWindowOptions);
   window_calc.document.write('<style>'
     + 'tr.DataTable3 { background: #ccffcc; font-size:10px }'
     + 'th.DataTable31 { border-top: black solid 3px;  background:#ccccff; padding-top:3px; padding-bottom:3px; font-size:12px; text-align:left;}'
     + 'th.DataTable32 { border-top: black solid 3px;  background:#E2F3ED; padding-top:3px; padding-bottom:3px; font-size:12px; text-align:left;}'
     + 'td.DataTable { padding-top:3px; padding-bottom:3px; padding-left:3px; padding-right:3px; text-align:center; }'
     + 'td.DataTable2 { padding-top:3px; padding-bottom:3px; padding-left:3px; padding-right:3px; text-align:right;}'
     + '</style>');
   window_calc.document.write('<BODY onload="window.print();window.close();">\n'
      + '<div width=500>' + html + '</div>'
      + '</BODY">\n')
   window_calc.document.close();
}
</script>
...
<!-------------------------------------------------------------------->
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Allowable Budget Review (Weekly) (OLD SCHEDULE PLATFORM - DO NOT USE AFTER 5/22/11)
      ...
      <a href="PrWkSched.jsp?STORE=<%=sStore%>&STRNAME=<%=sStrName.trim()%>&MONBEG=<%=sWkend%>&WEEKEND=<%=sWkend%>" target="_blank">Weekly Schedule</a>&nbsp;&nbsp;
      <a href="PrWkSched.jsp?STORE=<%=sStore%>&STRNAME=<%=sStrName.trim()%>&MONBEG=01/04/2099&WEEKEND=<%=sBaseSchDt%>" target="_blank">Base Schedule</a>&nbsp;&nbsp;
      <a href="javascript: showSlrEmpDays()">Salary Employee</a>
<!-------------------------------------------------------------------->
      <!----------------- beginning of table ------------------------>
     ...
     <tr class="DataTable">
        ...
        <th class="DataTable1" id="tdFold">Sales Forecast Dollars +/-</th>
        <%for(int i=0; i < 8; i++){%>
     ...
     <tr class="DataTable">
        ...
        <th class="DataTable1" id="tdFold">Sales Actual / Forecast Dollars +/-</th>
        <%for(int i=0; i < 8; i++){%>
     ...
     <!-- tr class="DataTable" -->
        ...
        <%for(int i=0; i < 8; i++){%>
           <td  id="tdFold" class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">
              <%=sHrsEarned[i]%><%if(sWarnL10[i].equals("1")){%><sup>*</sup><%}%>
           </td>
        <%}%>
     </tr>
     <tr class="DataTable">
        ...
        <%for(int i=0; i < 8; i++){%>
           <td  id="tdFold" class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">
           <%if(i==7 && !sHrsEarnedNoSlry[i].equals("0")){%><a href="javascript: dispSlrReserv('<%=sBaseSchDt%>', '<%=sBaseSlrHrs%>', '<%=sCurrSlrHrs%>', '<%=sHrsEarnedNoSlry[i]%>')"><%=sHrsEarnedNoSlry[i]%></a><%} else {%><%=sHrsEarnedNoSlry[i]%><%}%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < 8; i++){%>
           ...
           <%if(i==7){%><a href="javascript: dspCalcFormula('<%=i%>','<%=sBdgHrs[7]%>','<%=sBdgPay[7]%>', '<%=sBdgAvg[7]%>', '<%=sActSlsDiff[7]%>', '<%=sBdgPayOfSls[7]%>', '<%=sHrsEarned[i]%>', '<%=sHrsEarnedNoSlry[7]%>', '<%=sSlsCommRatio%>', '<%=sSlsCommRate%>', '<%=sLSpiff%>', '<%=sPSpiff%>', '<%=sSlsPayrollPrc%>', '<%=sActSls[7]%>', '<%=sSlsPlan[7]%>', 'alwhrs')"><%=sHrsAllowed[i]%></a><%if(sWarnL10[i].equals("1")){%><sup>*</sup><%}%><%} else {%><%=sHrsAllowed[i]%><%if(sWarnL10[i].equals("1")){%><sup>*</sup><%}%><%}%>
           </td>
        <%}%>
     </tr>
     <tr class="DataTable">
        <th class="DataTable11">Mike Parker Allowable Budget Hours</th>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < 8; i++){%>
           <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">
               <%if(i==7){%><a href="javascript: dspCalcFormula('<%=i%>','<%=sBdgHrs[7]%>','<%=sBdgPay[7]%>', '<%=sBdgAvg[7]%>', '<%=sActSlsDiff[7]%>', '<%=sBdgPayOfSls[7]%>', '<%=sHrsEarned[i]%>', '<%=sHrsEarnedNoSlry[7]%>', '<%=sSlsCommRatio%>', '<%=sSlsCommRate%>', '<%=sLSpiff%>', '<%=sPSpiff%>', '<%=sSlsPayrollPrc%>', '<%=sActSls[7]%>', '<%=sSlsPlan[7]%>', 'alwdlr')">$<%=sPayAllowed[i]%></a><%if(sWarnL10[i].equals("1")){%><sup>*</sup><%}%><%} else {%>$<%=sPayAllowed[i]%><%if(sWarnL10[i].equals("1")){%><sup>*</sup><%}%><%}%>
           </td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <td class="DataTable21">
            <a href="javascript: dspCalcFormula('7','<%=sBdgHrs[7]%>','<%=sBdgPay[7]%>', '<%=sBdgAvg[7]%>', '<%=sActSlsDiff[7]%>', '<%=sBdgPayOfSls[7]%>', '<%=sHrsEarned[7]%>', '<%=sHrsEarnedNoSlry[7]%>', '<%=sSlsCommRatio%>', '<%=sSlsCommRate%>', '<%=sLSpiff%>', '<%=sPSpiff%>', '<%=sSlsPayrollPrc%>', '<%=sActSls[7]%>', '<%=sSlsPlan[7]%>', 'alwavg')">$<%=sAlwHrRate%></a><%if(sWarnL10[7].equals("1")){%><sup>*</sup><%}%>
        </td>
     </tr>
     ...
     <tr class="DataTable">
        <th rowspan=4></th>
        <th class="DataTable26" rowspan=4>TMC</th>
        ...
        <%}%>
        <td class="DataTable2" rowspan=4></td>
     </tr>
     <!--------------------- Hours Actual/Scheduled - TMC ---------------------->
     <tr class="DataTable">
        <th class="DataTable05">2</th>
        <th class="DataTable15">Hours Actual/Scheduled - TMC</th>
        <%for(int i=0; i < 8; i++){%>
            <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>"><%=sActTmcHrs[i]%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < 8; i++){%>
            <td class="DataTable2<%if(i < iNumOfPassDays){%>p<%}%>">$<%=sActTmcPay[i]%></td>
        <%}%>
     </tr>
