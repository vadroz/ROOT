...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=EComStockAnlSel.jsp&APPL=ALL");
   }
   else
   {
     ...
     StoreSelect strlst = new StoreSelect(20);
...
function Validate()
{
  ...
  var compTo = document.all.SelStr.options[document.all.SelStr.selectedIndex].value;  
  var uniq = "N";
  if( document.all.Uniq.checked){ uniq="Y"; }
  
  if (error) alert(msg);
  else{ sbmPlan( selstr, compTo, uniq);  }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmPlan(selstr, compTo, uniq)
{
  var url = null;
  url = "EComStockAnl.jsp?CompTo=" + compTo 
      + "&Uniq=" + uniq; 
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce: Items w/o Inventory Statistics - Selection</B>
        <br><a href="/">Home</a>
      ...
      <TABLE>
        ...
        <tr><td  class="Cell3" colspan="5" ><u><b>Store Selection</b></u></td></tr> 
        <tr>
        ...
        <!-- ============== Compare to store ========================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
        <tr><td  class="Cell3" colspan="5" ><u><b>Compare to Store</b></u></td></tr> 
        <tr>
         <td  class="Cell3" colspan="5" >
       ...
       <!-- ============== Compare to store ========================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
        <tr><td  class="Cell3" colspan="5" ><u><b>Show Unique Only</b></u></td></tr> 
        <tr>
         <td  class="Cell3" colspan="5" >
           <input name="Uniq" class="Small" type="checkbox" value="Y" checked>           
         </td>
       </tr>
