<%@ page import="java.util.*, java.text.*, classreports.ChallResultDeux"%>
<%
    ...
    ChallResultDeux chreslt = new ChallResultDeux(sCode, sDate, sSort, sUser);
...
function showAnotherDay()
{
   ...
   var url = "ChallResultDeux.jsp?Code=<%=sCode%>&Name=<%=sName%>"
           + "&Date=" + sdate
           + "&ByPrc=" + ByPrc;
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR>
    <TD vAlign=top align=middle><b>Retail Concepts Inc.
      ...
      <!-- ============= Details =========================================== -->
         <%for(int i = 0; i < iNumOfStr; i++){%>
              <tr class="DataTable<%if(sStr[i].equals("Total")){%>9<%} else if(sStr[i].indexOf("Team")  >= 0 ){%>8<%}%>">
                 ...
                 <th class="DataTable1"><%if(sReward[i].equals("1")){%>$<%} else {%>&nbsp;<%}%></th>
   ...
   <table border=1>
     <tr>
        <th colspan=2>Team Alpha</th>
        <th colspan=2>Team Beta</th>
        <th colspan=2>Team Charlie</th>
     </tm>
     <tr>
        <td>Dale</td><td>3</td>
        <td>Paul</td><td>5</td>
        <td>Tricia</td><td>4</td>
     </tr>
     <tr>
        <td>Todd</td><td>11</td>
        <td>Rick</td><td>28</td>
     ...
     <tr>
        <td>Cassandra</td><td>30</td>
        <td>Kevin</td><td>45</td>
        <td>Stan</td><td>10</td>
     </tr>
     <tr>
        <td>Mynette</td><td>46</td>
        <td>Karl</td><td>50</td>
        <td>Scott</td><td>20</td>
     </tr>
     <tr>
        <td>Shelly</td><td>63</td>
        <td>Kelly</td><td>64</td>
        <td>Mike</td><td>35</td>
     </tr>
     <tr>
        <td>&nbsp;</td><td>82</td>
