<%@ page import="flashreps.SalesTyLy, counterpoint.UplStrDailySls, java.util.*
, java.text.DecimalFormat, java.text.SimpleDateFormat, rciutility.RunSQLStmt
, java.sql.*, java.math.BigDecimal"%>
<%
   ...
   /*System.out.println(sDivision + " " + sDepartment + " " + sClass + " "
    ...
    String [] sStrLst = new String[]{
       "3",  "4",  "5",  "6", "8", "10", "11", "15", "16", "17", "20", "22", "25", "28","29", "30", "35", "40",
       "42", "45","46", "50", "61", "63", "64", "66", "68", "70", "75", "77", "82", "86", "87", "88", "89", "90",
       "91", "92", "93", "96", "98" };
    boolean [] bMall = new boolean[]{
    false,  true, false, false, false, false, false, true, false, false, false, false, true, false, false, false, false, true, true, true,
    false, false, false,  false, false, false, true,  true,  true, true,  true, false, true, true, true, true,
    false, false, false, false, true };
                           //3  4  5  6  8 10 11 15 16 17 20 22 25 28 29 30 35 40 42 45  
    int [] iReg  = new int[]{1, 1, 1, 1, 1, 2, 2, 3, 1, 1, 2, 2, 1, 2, 2, 2, 3, 2, 2, 1,
                         // 46 50 61 63 64 66 68 70 75 77 82 86 87 88 89 90
                             3, 3, 3, 3, 3, 3, 3, 4, 4, 3, 1, 3, 1, 1, 4, 2,
                         // 91 92 93 96 98    
                             2, 3, 2, 2, 2 };
    boolean [] bCompStr = new boolean[]{
     // 3    4    5       6      8     10    11     15     16     17   20    22    25    28    29    30    35     40    42    45
      true, true, false, true,  true,  true, true, false, true, true, true, true, true, true, true, true, true,  true, true, true,
     // 46    50   61     63    64    66    68    70    75    77     82    86    87     88   89    90    
