<%@ page import="payrollreports.IncPlan5, rciutility.RunSQLStmt, java.text.SimpleDateFormat, java.sql.*, java.util.*"%>
<%
   ...
   IncPlan5 incp = new IncPlan5(sQtr, "MGR");
...
<!-------------------------------------------------------------------->
 ...
 <table border="0" width="100%" height="100%" cellPadding="0" cellSpacing="0">
   <tr bgColor="moccasin">
      ...
      <br><%if(sGrp.equals("MGR5")){%>Store Manager and Assistant Manager<%}
  ...
  <table class="DataTable" cellPadding="0" cellSpacing="0">
    <tr>
      ...
      <th class="DataTable" rowspan="3" >&nbsp;</th>
      <th class="DataTable" rowspan="2" colspan=<%if(sGrp.equals("MGR5") || sGrp.equals("MGRPI")){%>2<%} else {%>2<%}%>>Bonus<br>as a % of Pay</th>
      <th class="DataTable" rowspan="3">Store</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <%if(sGrp.equals("MGR5") || sGrp.equals("MGRPI")){%>
         <!--th class="DataTable">Aud</th-->
         <th class="DataTable">Pay<br>0.625%</th>
         <th class="DataTable">SFLS<br>0.625%</th>
    ...
    <tr class="DataTable2">
      <td class="DataTable1" colspan="2">Report Totals</td>
       ...
       <%if(sGrp.equals("MGR5") || sGrp.equals("MGRPI")){%>
           ...
           <td class="DataTable" bgcolor="<%=sRepBonusClr[3][3]%>" onmouseover="showTotScore('<%=dRepTotScr[3]%>', 'Pay', this)" onMouseOut="hideAlwTmc();"><%=sRepBonus[3][3]%></td>
           <td class="DataTable" bgcolor="<%=sRepBonusClr[3][4]%>" onmouseover="showTotScore('<%=dRepTotScr[4]%>', 'SFLS', this)" onMouseOut="hideAlwTmc();"><%=sRepBonus[3][4]%></td>
           <td class="DataTable" bgcolor="<%=sRepBonusClr[3][5]%>" onmouseover="showTotScore('<%=dRepTotScr[5]%>', 'Survey',this)" onMouseOut="hideAlwTmc();"><%=sRepBonus[3][5]%></td>
           <td class="DataTable" bgcolor="<%=sRepBonusClr[3][6]%>" onmouseover="showTotScore('<%=dRepTotScr[6]%>', 'Train', this)" onMouseOut="hideAlwTmc();"><%=sRepBonus[3][6]%></td>
           <td class="DataTable" bgcolor="<%=sRepBonusClr[3][7]%>" onmouseover="showTotScore('<%=dRepTotScr[7]%>', 'Comp Rpt', this)" onMouseOut="hideAlwTmc();"><%=sRepBonus[3][7]%></td>
       <%}%>
...
<!---------------------------- end of Report Totals ------------------------------>
 ...
 <p  align="left" style="font-size:12px">   
   *Survey Scores are ONLY updated weekly.
   <br>*Payroll dollars exclude commission and Challenge Pay, but include TMC.   
   <br>*To earn any category, including sales you must have a positive PvO
   <br><a href="Calendar/Fiscal Calendar.pdf" target="_blank">Fiscal Calendar</a>
   
   <%if(sGrp.equals("MGR5")) {%><br>*To see Incentive Plan Table click <a href="IncPlanArchive/Incentive_Plan_Table_Q1_2017.pdf" target="_blank">here</a><%}
