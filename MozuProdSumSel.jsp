...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=MozuProdSumSel.jsp&APPL=ALL");
   }
   else
   {
...
function Validate()
{
  ...
  {
	  if(grpobj[i].checked){grp[grp.length] = grpobj[i].value; grpchk = true; }
  }	  
  if(!grpchk){error=true; msg += "Please, check at least 1 Data Grouping";}
  
  if (error) alert(msg);
  else{ sbmPlan(div, dpt, cls, ven, season, ready, approved, assign, excel, site, stock
		  , po30dy, po60dy, po90dy, grp) }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmPlan(div, dpt, cls, ven, season, ready, approved, assign, excel, site, stock
		, po30dy, po60dy, po90dy, grp)
{
  var url = null;
  url = "MozuProdSum.jsp?"
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    ...
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce Product Summary List - Selection</B>
      ...
      <TABLE>
        ...
        <TR>
            <TD class="Cell2" colspan=4>Item Completion</TD>            
        </tr>
        <tr>
        ...
        <TR><TD style="border-bottom:darkred solid 1px" colspan="4" >&nbsp;</TD></TR>
        <TR>
            <TD class="Cell2" colspan=4>Report Data Grouping</TD>            
        </tr>
        <tr>
            <TD class="Cell2" colspan=4>
              <input class="Small" name="Grp" type="checkbox" value="DIV" checked>Division &nbsp; &nbsp; &nbsp; &nbsp;
              <input class="Small" name="Grp" type="checkbox" value="DPT">Department &nbsp; &nbsp; &nbsp; &nbsp;
              <input class="Small" name="Grp" type="checkbox" value="CLASS">Class &nbsp; &nbsp; &nbsp; &nbsp;
              <input class="Small" name="Grp" type="checkbox" value="VEND">Vendor &nbsp; &nbsp; &nbsp; &nbsp;
        <!-- =============================================================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="4" >&nbsp;</TD></TR>
        <tr>
