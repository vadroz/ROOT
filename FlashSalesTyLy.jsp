<%@ page import="flashreps.SalesTyLy, flashreps.RcvSalesDate, java.util.*, java.text.SimpleDateFormat
...
<%
   ...
   if (bAvail)
   {
      ...
      String [][] sTyEcom = slsTyLy.getTyEcom();
      String [][] sLyEcom = slsTyLy.getLyEcom();
      String [][] sTyStrEcom = slsTyLy.getTyStrEcom();
      String [][] sLyStrEcom = slsTyLy.getLyStrEcom();      
      String [][] sTyEcomOd = slsTyLy.getTyEcomOd();
      String [][] sLyEcomOd = slsTyLy.getLyEcomOd();
      ...
      String [][] sMallTyEcom = slsTyLy.getMallTyEcom();
      String [][] sMallLyEcom = slsTyLy.getMallLyEcom();
      String [][] sMallTyStrEcom = slsTyLy.getMallTyStrEcom();
      String [][] sMallLyStrEcom = slsTyLy.getMallLyStrEcom();
      ...
      String [][] sPatioComPrc = slsTyLy.getPatioComPrc();
      String [][] sPatioTyKio = slsTyLy.getPatioTyKio();
      String [][] sPatioLyKio = slsTyLy.getPatioLyKio();
      String [][] sPatioTyStrKio = slsTyLy.getPatioTyStrKio();
      String [][] sPatioLyStrKio = slsTyLy.getPatioLyStrKio();
      String [][] sPatioTyEcom = slsTyLy.getPatioTyEcom();
      String [][] sPatioLyEcom = slsTyLy.getPatioLyEcom();
      String [][] sPatioTyStrEcom = slsTyLy.getPatioTyStrEcom();
      String [][] sPatioLyStrEcom = slsTyLy.getPatioLyStrEcom();      
      ...
      String [][] sRegTyEcom = slsTyLy.getRegTyEcom();
      String [][] sRegLyEcom = slsTyLy.getRegLyEcom();
      String [][] sRegTyStrEcom = slsTyLy.getRegTyStrEcom();
      String [][] sRegLyStrEcom = slsTyLy.getRegLyStrEcom();
      ...
      String [][] sRegCompTyEcom = slsTyLy.getRegCompTyEcom();
      String [][] sRegCompLyEcom = slsTyLy.getRegCompLyEcom();
      String [][] sRegCompTyStrEcom = slsTyLy.getRegCompTyStrEcom();
      String [][] sRegCompLyStrEcom = slsTyLy.getRegCompLyStrEcom();      
      ...
      String [] sRepTyEcom = slsTyLy.getRepTyEcom();
      String [] sRepLyEcom = slsTyLy.getRepLyEcom();
      String [] sRepTyStrEcom = slsTyLy.getRepTyStrEcom();
      String [] sRepLyStrEcom = slsTyLy.getRepLyStrEcom();
      ...
      String [][] sTyDyTempAvg = slsTyLy.getTyDyTempAvg();
      String [][] sLyDyTempAvg = slsTyLy.getLyDyTempAvg();
      String [][] sDyTempClr = slsTyLy.getDyTempClr();
      ...
      String [] sTyTotDyTempAvg = slsTyLy.getTyTotDyTempAvg();
      String [] sLyTotDyTempAvg = slsTyLy.getLyTotDyTempAvg();
      String [] sDyTotTempClr = slsTyLy.getDyTotTempClr();

      // rank LY Avg Temp
      slsTyLy.setLyTempAvgRank();
      String [] sLyTotDyAvgRank = slsTyLy.getLyTotDyAvgRank();
      ...
      String sLyCol = "LY";
      if (sPeriod.substring(5).equals("PLAN")) sLyCol = "Target";
      ...
      String [][] sDtl = new String[iNumOfGrp][11];
      for(int i=0; i < iNumOfGrp; i++)
      {
    	  ...
    	  sDtl[i][1] = "\"" + sTySls[i][9] + "\"";
    	  sDtl[i][2] = "\"" + sLySls[i][9] + "\"";
    	  sDtl[i][3] = "\"" + sDlyPrc[i][9] + "%\"";
    	  sDtl[i][4] = "\"" + sLySls[i][10] + "\"";
    	  //QTD
    	  sDtl[i][5] = "\"" + sTySls[i][11] + "\"";
    	  sDtl[i][6] = "\"" + sLySls[i][11] + "\"";
    	  sDtl[i][7] = "\"" + sDlyPrc[i][11] + "%\"";
    	  //YTD
    	  sDtl[i][8] = "\"" + sTySls[i][12] + "\"";
    	  sDtl[i][9] = "\"" + sLySls[i][12] + "\"";
    	  sDtl[i][10] = "\"" + sDlyPrc[i][12] + "%\"";
      }
      String sToxl = slsTyLy.cvtTo2DimensionJSA(sDtl);
      boolean bToExcl = sPeriod.equals("YTDTYLY");
      
      String sSelStrJsa = slsTyLy.cvtToJavaScriptArray(sStore);
...
<style>body {background:ivory;}
        ...
        td.DataTable313 { padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: darkred solid 1px; border-right: black solid 2px;
                       text-align:center;}
        ...
        td.DataTable413 { padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:right;}
        ...
        td.DataTable714 { color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable715 { color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 2px;
                       text-align:center;}
        td.DataTable716 { color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:center;}

        td.DataTable7G { background:#58FAF4; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable71G { background:#58FAF4; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable712G { background:#58FAF4; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable713G { background:#58FAF4; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable714G { background:#58FAF4; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable715G { background:#58FAF4; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 2px;
                       text-align:center;}
        td.DataTable716G { background:#58FAF4; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:center;}

        td.DataTable7P { background:pink; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable71P { background:pink; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable712P { background:pink; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable713P { background:pink; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable714P { background:pink; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable715P { background:pink; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 2px;
                       text-align:center;}
        td.DataTable716P { background:pink; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:center;}

        td.DataTable7B { background:#58ACFA; color: white; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable71B { background:#58ACFA; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable712B { background:#58ACFA; color: white; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable713B { background:#58ACFA; color: red; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable714B { background:#58ACFA; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable715B { background:#58ACFA; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 2px;
                       text-align:center;}
        td.DataTable716B { background:#58ACFA; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:center;}

        td.DataTable7R { background: #FE642E; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable71R { background: #FE642E; color: white; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable712R { background: #FE642E; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable713R { background: #FE642E; color: white; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable714R { background:#FE642E; color: blue; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 1px;
                       text-align:center;}
        td.DataTable715R { background: #FE642E; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: darkred solid 2px;
                       text-align:center;}
        td.DataTable716R { background: #FE642E; color: black; padding-top:2px; padding-bottom:2px; padding-left:2px; padding-right:2px;
                       border-bottom: #FFCC99 solid 1px; border-right: black solid 2px;
                       text-align:center;}
        ...
        div.dvEvtCal { visibility:hidden; border:ridge; width:250; background-color:LemonChiffon;
              text-align:center; font-size:10px; page-break-before:always}
...
function rtvEvtCal()
{
   ...
   if(isIE){ window.frame3.location.href = url; }
   else if(isChrome || isEdge) { window.frame3.src = url; }
   else if(isSafari){ window.frame3.location.href = url; }
}
//==============================================================================
// set Event Calendar arrays
//==============================================================================
function popEvtCalArr(Column, Event, From, To, EvtText, EvtMemo, EvtSign, EvtTrack
...
function buildEvtCal()
{
   ...
   html += "<table class='DataTable' cellPadding='0' cellSpacing='0'>"
          + "<tr class='TblHdr'>"
            ...
            + "<td class='DataTable2'>D<br>i<br>r<br>e<br>c<br>t<br>i<br>v<br>e<br>s</td>"
            + "<td class='DataTable2'>M<br>a<br>n<br>i<br>f<br>e<br>s<br>t</td>"
            + "<td class='DataTable2'>A<br>d<br>v</td>"
            + "<td class='DataTable2'>T<br>r<br>a<br>c<br>k<br>i<br>n<br>g</td>"
          + "</tr>"

   var ly = false;
   html += "<tr class='DataTable2'><td class='DataTable1' colspan=8>This Year</td></tr>"
   for(var i=0; i < Event.length; i++)
   {
      if(Year[i]=="0" && !ly)
      {
         html += "<tr class='DataTable2'><td class='DataTable1' colspan=8>Last Year</td></tr>";
         ly = true;
      }
      ...
      html += "<tr class='DataTable'>"
               ...
               + "<td class='DataTable1'><a href='javascript:showDoc(" + i + ",&#34;MEMO&#34;)'>D</a></td>"
               + "<td class='DataTable1'><a href='javascript:showDoc(" + i + ",&#34;SIGN&#34;)'>M</a></td>"
               + "<td class='DataTable1'><a href='javascript:showAdv(" + i + ")'>A</a></td>"
               + "<td class='DataTable1'><a href='javascript:showDoc(" + i + ",&#34;TRACK&#34;)'>T</a></td>"
           + "</tr>"
    }
   html += "</table>";
...
function setNextLvl(grp)
{
  ...
  if (Level=="S")
  {
    ...
    else if (grp.substring(0, 4)=="DME") lvl = "S";
    else if (grp.substring(0, 4)=="DMF") lvl = "S";
...
function popPanel()
{
   ...
   var panel = "<table cellPadding='0' cellSpacing='0'  width='100%'>"
      ...
      panel += "<tr><td class='Prompt'' nowrap colspan=2>"
         + "Report:<br>"
      ...
      + "<tr><td class='Prompt1' colspan=2><button onClick='Validate()' class='Small'>Submit</button>&nbsp;"
...
function showDoc(arg, type)
{
   var hdr = " Memo List";
   var doc = EvtMemo;
   if(type =='SIGN') { hdr = "Manifest";  doc = EvtSign; }
   else if(type =='TRACK') { hdr = "Tracking";  doc = EvtTrack; }
   ...
   document.all.dvPrompt.innerHTML = html;
   document.all.dvPrompt.style.left= getLeftScreenPos() + 400;
   document.all.dvPrompt.style.top= getTopScreenPos() + 130;
   document.all.dvPrompt.style.visibility = "visible";
}
//--------------------------------------------------------
...
function showEvent(arg)
{
   ...
   document.all.dvPrompt.style.top= getTopScreenPos() + 120;
   document.all.dvPrompt.style.visibility = "visible";
}
//--------------------------------------------------------
...
//--------------------------------------------------------
// show / hide daily/comulative % on temperature atound store table
//--------------------------------------------------------
function showTempSls()
{
   var prc = document.all.trTmpSlsPrc;
   var str = document.all.trTmpStr;
   for(var i=0; i < prc.length; i++)
   {
      if(prc[i].style.display!="none")
      {
         prc[i].style.display="none";
         str[i].rowSpan=1;
      }
      else
      {
         prc[i].style.display="block";
         str[i].rowSpan=2;
      }
   }
}
...
function showDlyComPrc(rowId, kioOnly)
{
  ...
  if  ( disp =="block" || document.all.tdPrc[0].style.display == "block"
       || document.all.tdKioskMemo[0].style.display == "block") { Row = 4;}
  for(var i=0; i < document.all.tdGrp.length; i++)
  {
    if(document.all.tdGrp[i].innerHTML.indexOf("DMM") < 0 && document.all.tdGrp[i].innerHTML.indexOf("Mall") < 0 
       && document.all.tdGrp[i].innerHTML.indexOf("District") < 0 && document.all.tdGrp[i].innerHTML.indexOf("Patio") < 0
       && document.all.tdGrp[i].innerHTML.indexOf("Comp Str") < 0 
       && document.all.tdGrp[i].innerHTML.indexOf("Report") < 0
       || document.all.tdGrp[i].innerHTML.indexOf("82") >= 0 || document.all.tdGrp[i].innerHTML.indexOf("98") >= 0
       )
    {
    	if(document.all.tdGrp[i].innerHTML.indexOf("70") >= 0)
        {
    		document.all.tdGrp[i].rowSpan = Row + 1;
    	}
    	else {document.all.tdGrp[i].rowSpan = Row;}
    }
    else if((document.all.tdGrp[i].innerHTML.indexOf("Mall") >= 0 
    		|| document.all.tdGrp[i].innerHTML.indexOf("District") >= 0
    		|| document.all.tdGrp[i].innerHTML.indexOf("Patio") >= 0
    		|| document.all.tdGrp[i].innerHTML.indexOf("Comp Str")
    		|| document.all.tdGrp[i].innerHTML.indexOf("Report") >= 0) && Row > 1)
    {
          document.all.tdGrp[i].rowSpan = 3;
    }
...
//==============================================================================
// link to flash sales gm
//==============================================================================
function flashGM()
{
	var url="FlashSlsMargin.jsp?Div=<%=sDivision%>&Dpt=<%=sDepartment%>&Cls=<%=sClass%>"
	...
	var showby = "STR"; 
	if(Level != "S"){ showby = "MERCH"; }
	url += "&ShowBy=" + showby + "&ToDate=<%=sTyDate[6]%>&col=4";
...
//link to flash sales gm
//==============================================================================
function flashToExcel()
{
	var form = document.all.frmToExl;
	var nwelem = window.frame2.document.createElement("input");
	
	var nwelem = window.document.createElement("div");
	nwelem.id = "dvToXl";
	
	var html = "<form name='frmToExl'"
	  + " METHOD=Post ACTION='FlashToExcel.jsp'>"
	  + "<input class='Small' name='Hdr1'>"
	  + "<input class='Small' name='Hdr2'>"	  
	;       
    
	for(var i=0; i < DtlToXl.length; i++)
	{
    	html += "<input class='Small' name='Dtl'>";
	}      
	...
	window.document.appendChild(nwelem);
			
	var hdr1 = "";
	if(Level == "S"){hdr1 = "Str";}
	else if(Level == "D"){hdr1 = "Div";}
	else if(Level == "P"){hdr1 = "Dpt";}
	else if(Level == "C"){hdr1 = "Class";}
	
	hdr1 += ",Month To Date, , ,LY Month Ending,Quater To Date, , ,Year To Date, , ";
	
	var hdr2 = " ,TY,LY,Var, ,TY,LY,Var,TY,LY,Var";
	
	document.all.Hdr1.value = hdr1;
	document.all.Hdr2.value = hdr2;
		
	for(i = 0; i < DtlToXl.length; i++)
	{
		document.all.Dtl[i].value = DtlToXl[i];		
	}
	document.frmToExl.submit();	
	
	var elem = document.getElementById("dvToXl");
...
<!-------------------------------------------------------------------->
      <td ALIGN="left" VALIGN="TOP" width="10%" style="padding-left:10px;padding-top:3px; padding-right:10px;" nowrap>
        <div id="selBox" class="selBox" onClick="chgSelection()">
           ...
           <br>Store: <b>
           <%if(sStore[0].startsWith("ALL") || sStore[0].startsWith("COMP") || sStore[0].startsWith("REG")){%><%=sSelStrName%><%}
           else {%>
           		<%String sComma = "";//sSelStrName
           		for(int i=0; i < sStore.length; i++){%><%=sComma%><%=sStore[i]%> <%sComma = ","; }%>
           <%}%>	 
           </b>
...
<!-------------------------------------------------------------------->
      ...
      <td ALIGN="center" VALIGN="TOP" nowrap>
        ...
        <br>Flash Sales Comparison Report: TY vs. <%=sLyCol%>
        <br>Compare date Range <%=sTyDate[0]%> thru <%=sTyDate[6]%>
            to Range <%=sLyDate[0]%> thru <%=sLyDate[6]%>
        <br></b>
        <%if(sPeriod.equals("MTDTYLY")){%><a href="javascript: flashGM()">Flash Sales - GM</a><%}%>
      </td>
     ...
     <tr bgColor="ivory">
      ...
      <a href="<%if(!bKiosk){%>index.jsp<%} else {%>Outsider.jsp<%}%>"><font color="red" size="-1">Home</font></a>&#62;
          ...
          &nbsp; &nbsp; &nbsp; &nbsp;
          <%if(bKioskAllows){%>
            <a href="javascript: showDlyComPrc('tdKioskMemo', true)"><font size="-1">Kiosk & Ecom Memo</font></a>
            <a href="javascript: showDlyComPrc('tdKioskMemo', false)"><font size="-1">Kiosk+Ecom+Str Memo</font></a>
            <%/*if  (sStore.equals("ALL") && (sLevel.equals("S") || sLevel.equals("D")) ){*/%>
              <!--a href="javascript: gotoMallBooth()"><font size="-1">Mall Booth Sales</font></a -->
            <%/*}*/%>
          <%}%>
<!-------------------------------------------------------------------->
      <!----------------- beginning of table ------------------------>
      <table class="DataTable" cellPadding="0" cellSpacing="0" width="100%" id="tblFlash">
      <thead id="tbhHdr">
        <tr class="TblHdr" id="trHdr">
	  <td class="DataTable3"  rowspan="3">
            <a href="javascript:sortBy('GRP')"><%=sColName%></a><br><br>
             <%if  (sStore[0].equals("ALL")
                 || sStore[0].length() > 2 && sStore[0].substring(0, 3).equals("REG")
                 || sStore[0].length() > 2 && sStore[0].substring(0, 3).equals("RCS")
                 || sStore[0].length() > 3 && sStore[0].substring(0, 4).equals("MALL")
                 || sStore[0].length() > 3 && sStore[0].substring(0, 4).equals("COMP")
                 || sStore.length > 1 ){%>
        ...
        <tr class="TblHdr"  id="trHdr">
          <%if(sPeriod.substring(0, 3).equals("MTD")){%>
             <td class="DataTable3"><a href="javascript: sortBy('TY1')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY1')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY2')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY2')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY3')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY3')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY4')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY4')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY5')">TY</td>
             <td class="DataTable31"><a href="javascript: sortBy('LY5')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY6')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY6')"><%=sLyCol%></a></td>
             <td class="DataTable3"><a href="javascript: sortBy('TY7')">TY</a></td>
             <td class="DataTable31"><a href="javascript: sortBy('LY7')"><%=sLyCol%></a></td>
...
<!------------------------------- Data Detail --------------------------------->
      <%for(int i=0, str=0, reg=0; i < iNumOfGrp; i++) {
    	  ...
    	  boolean b70EcOd = false;
          if(sLevel.equals("S") && sGrp[i].trim().equals("70") && bKioskAllows){ b70EcOd = true; }
      %>
        <tr class="DataTable" id="trGrp" onmouseover="hiliDtlLine(this, true)" onmouseout="hiliDtlLine(this, false)">
           <%if(!sLevel.equals("T") && !sLevel.equals("V") && sPeriod.indexOf("PLAN") < 0  && (!sLevel.equals("C") 
        		   || sStore[0].equals("ALL") && sLevel.equals("S")) ) {%>
               <td class="DataTable5" id="tdGrp" rowspan=3 onClick="drillDown('<%=sGrp[i]%>')"  nowrap>
                    <%if(b70EcOd) {%>
                       <table>
                       	 <tr class="DataTable">
                       	     <td class="DataTable5"><%=sGrp[i] + " - " + sGrpName[i].trim()%></td>
                       	     <td>Ship Date</td>
                       	 </tr>
                       	 <!-- tr class="DataTable" ><td>(Memo) Demand Date</td></tr -->                       	 
                       </table> 
                    <%}  else {%>
                    	<%=sGrp[i] + " - " + sGrpName[i].trim()%>
                    <%}%> 
                    
               </td>
           <%}
           else {%><td class="DataTable1" id="tdGrp" rowspan=3 nowrap><%=sGrp[i] + " - " + sGrpName[i].trim()%></td><%}%>
        ...
        <!-- Ecom by Order Date -->
        <%if(b70EcOd) {%>    
        <!-- tr class="DataTable" style="background: #c8c8c8; color:white">
           <%if(sPeriod.substring(0, 3).equals("MTD")){%>
              <%for(int j=0; j < 7; j++){%>
                 <td class="DataTable4" id="tdEcOd" nowrap><%=sTyEcomOd[i][j]%></td>
                 <td class="DataTable41" id="tdEcOd" nowrap><%=sLyEcomOd[i][j]%></span></td>
              <%}%>
              <td class="DataTable4" id="tdEcOd"><%=sTyEcomOd[i][7]%></td>
              <td class="DataTable4" id="tdEcOd"><%=sLyEcomOd[i][7]%></td>
              <td class="DataTable41" id="tdEcOd">&nbsp;</td>

              <td class="DataTable41" id="tdEcOd"><%=sLyEcomOd[i][8]%></td>
           <%}%>
           <td class="DataTable4" id="tdEcOd"><%=sTyEcomOd[i][9]%></td>
           <td class="DataTable4" id="tdEcOd"><%=sLyEcomOd[i][9]%></td>
           <td class="DataTable41" id="tdEcOd">&nbsp;</td>

           <td class="DataTable41" id="tdEcOd"><%=sLyEcomOd[i][10]%></td>
           <%if(sPeriod.substring(0, 3).equals("YTD")){%>
              <td class="DataTable4" id="tdEcOd"><%=sTyEcomOd[i][11]%></td>
              <td class="DataTable4" id="tdEcOd"><%=sLyEcomOd[i][11]%></td>
              <td class="DataTable41" id="tdEcOd" nowrap>&nbsp;</td>

              <td class="DataTable4" id="tdEcOd"><%=sTyEcomOd[i][12]%></td>
              <td class="DataTable4" id="tdEcOd"><%=sLyEcomOd[i][12]%></td>
              <td class="DataTable41" id="tdEcOd" nowrap>&nbsp;</td>
           <%}%>
        </tr -->
        <%}%>
        ...
        <tr class="DataTable">
           <%if(sPeriod.substring(0, 3).equals("MTD")){%>
              <%for(int j=0; j < 7; j++){%>
                 <td class="DataTable4" id="tdKioskMemo" nowrap><span id="spKiosk">$<%=sTyEcom[i][j]%></span><span id="spStrKiosk">$<%=sTyStrEcom[i][j]%></span></td>
                 <td class="DataTable41" id="tdKioskMemo" nowrap><span id="spKiosk">$<%=sLyEcom[i][j]%></span><span id="spStrKiosk">$<%=sLyEcom[i][j]%></span></td>
              <%}%>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sTyEcom[i][7]%></span><span id="spStrKiosk"><%=sTyStrEcom[i][7]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][7]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][7]%></span></td>
              <td class="DataTable41" id="tdKioskMemo">&nbsp;</td>

              <td class="DataTable41" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][8]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][8]%></span></td>
           <%}%>
           <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sTyEcom[i][9]%></span><span id="spStrKiosk"><%=sTyStrEcom[i][9]%></span></td>
           <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][9]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][9]%></span></td>
           <td class="DataTable41" id="tdKioskMemo">&nbsp;</td>

           <td class="DataTable41" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][10]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][10]%></span></td>
           <%if(sPeriod.substring(0, 3).equals("YTD")){%>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sTyEcom[i][11]%></span><span id="spStrKiosk"><%=sTyStrEcom[i][11]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][11]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][11]%></span></td>
              <td class="DataTable41" id="tdKioskMemo" nowrap>&nbsp;</td>

              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sTyEcom[i][12]%></span><span id="spStrKiosk"><%=sTyStrEcom[i][12]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sLyEcom[i][12]%></span><span id="spStrKiosk"><%=sLyStrEcom[i][12]%></span></td>
              <td class="DataTable41" id="tdKioskMemo" nowrap>&nbsp;</td>
           <%}%>
        </tr>
    ...
    <%if(sStore[0].equals("ALL") && sLevel.equals("S")){%>
      <%for(int i=0; i < 2; i++) {%>
        <tr class="DataTable5">
           <%if(sStore[0].equals("ALL") && sLevel.equals("S")){%>
                 <td class="DataTable6" id="tdGrp" rowspan=3  onClick="drillDown('<%if(i==0){%>MALLY<%} else {%>MALLN<%}%>')"><%=sMall[i]%> - (Click for Stores)</td>
           <%} else {%>
    ...
    <%if(sStore[0].equals("ALL") && sDivision.equals("ALL") && sDepartment.equals("ALL")
        && sClass.equals("ALL")){%>
      <%for(int i=0; i < 2; i++) {%>
        <tr class="DataTable5">
           <%if(sStore[0].equals("ALL") && sLevel.equals("S")){%>
                 <td class="DataTable6" id="tdGrp" rowspan=3><%=sPatio[i]%> - (Click for Stores)</td>
           <%} else {%>
                 <td class="DataTable4" id="tdGrp" rowspan=3><%=sPatio[i]%></td>
           <%}%>
         <%if(sPeriod.substring(0, 3).equals("MTD")){%>
           <td class="DataTable4"><%=sPatioTySls[i][0]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][0]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][1]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][1]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][2]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][2]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][3]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][3]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][4]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][4]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][5]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][5]%></td>
           <td class="DataTable4"><%=sPatioTySls[i][6]%></td>
           <td class="DataTable41"><%=sPatioLySls[i][6]%></td>

           <td class="DataTable4"><%=sPatioTySls[i][7]%></td>
           <td class="DataTable4"><%=sPatioLySls[i][7]%></td>
           <td class="DataTable41"><%=sPatioDlyPrc[i][7]%>%</td>
           <td class="DataTable41"><%=sPatioLySls[i][8]%></td>
         <%}%>

           <td class="DataTable4"><%=sPatioTySls[i][9]%></td>
           <td class="DataTable4"><%=sPatioLySls[i][9]%></td>
           <td class="DataTable41"><%=sPatioDlyPrc[i][9]%>%</td>
           <td class="DataTable41"><%=sPatioLySls[i][10]%></td>
         ...
         <%}%>
           ...
           <td class="DataTable41" id="tdGrp" rowspan=3 ><%=sPatio[i]%></td>
        </tr>

        <!-- Percents is allowed  -->
           <tr class="DataTable5">
              <%if(sPeriod.substring(0, 3).equals("MTD")){%>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][0]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][0]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][1]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][1]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][2]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][2]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][3]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][3]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][4]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][4]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][5]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][5]%>%</td>
                <td class="DataTable4" id="tdPrc" nowrap><%=sPatioDlyPrc[i][6]%>%</td>
                <td class="DataTable41" id="tdPrc" nowrap><%=sPatioComPrc[i][6]%>%</td>
                <td class="DataTable41" id="tdPrc" colspan=8>&nbsp;</td>
              <%}%>
           </tr>
        <!-- Kiosk -->
        <tr class="DataTable5">
           <%if(sPeriod.substring(0, 3).equals("MTD")){%>
              <%for(int j=0; j < 7; j++){%>
                 <td class="DataTable4" id="tdKioskMemo" nowrap><span id="spKiosk">$<%=sPatioTyKio[i][j]%></span><span id="spStrKiosk">$<%=sPatioTyStrKio[i][j]%></td>
                 <td class="DataTable41" id="tdKioskMemo" nowrap><span id="spKiosk">$<%=sPatioLyKio[i][j]%></span><span id="spStrKiosk">$<%=sPatioLyStrKio[i][j]%></span></td>
              <%}%>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioTyKio[i][7]%></span><span id="spStrKiosk"><%=sPatioTyStrKio[i][7]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][7]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][7]%></span></td>
              <td class="DataTable41" id="tdKioskMemo">&nbsp;</td>

              <td class="DataTable41" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][8]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][8]%></span></td>
           <%}%>

           <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioTyKio[i][9]%></span><span id="spStrKiosk"><%=sPatioTyStrKio[i][9]%></span></td>
           <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][9]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][9]%></span></td>
           <td class="DataTable41" id="tdKioskMemo">&nbsp;</td>

           <td class="DataTable41" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][10]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][10]%></span></td>
           <%if(sPeriod.substring(0, 3).equals("YTD")){%>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioTyKio[i][11]%></span><span id="spStrKiosk"><%=sPatioTyStrKio[i][11]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][11]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][11]%></span></td>
              <td class="DataTable41" id="tdKioskMemo" nowrap>&nbsp;</td>

              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioTyKio[i][12]%></span><span id="spStrKiosk"><%=sPatioTyStrKio[i][12]%></span></td>
              <td class="DataTable4" id="tdKioskMemo"><span id="spKiosk"><%=sPatioLyKio[i][12]%></span><span id="spStrKiosk"><%=sPatioLyStrKio[i][12]%></span></td>
              <td class="DataTable41" id="tdKioskMemo" nowrap>&nbsp;</td>
           <%}%>
    ...
    <!------------------- DMM Category Totals --------------------------------->
    <%if(sDivision.equals("ALL") && !sLevel.equals("T") && !sLevel.equals("V")){%>
      <%for(int i=0; i < iNumOfDmm; i++) {%>
        <tr class="DataTable6" style="background:<%=sDmmColor[i]%>;">
         ...
         <td class="DataTable6" <%if(sLevel.equals("D")) {%> onMouseOver="getTool(this, '<%=i%>')"<%}%>
           id="tdGrpDMM" onClick="drillDown('DM<%=sDmmCode[i]%>')"><%=sDmmName[i]%></td>
         <%if(sPeriod.substring(0, 3).equals("MTD")){%>
    ...
    <!------------------- Regional Total ------------------------------------>
    <%if(sLevel.equals("S") && (sStore[0].length() >= 3 && !sStore[0].substring(0, 3).equals("RCS") || sStore.length > 1)) {%>    
      <%for(int i=0; i < iNumOfReg; i++) {%>
        <tr class="DataTable1">
           <%if(sStore[0].length() >= 3 && sStore[0].substring(0, 3).equals("ALL")){%>
              <td class="DataTable6" id="tdGrp" rowspan=3  onClick="drillDown('REG<%=sReg[i]%>')">District <%=sReg[i]%></td>
           <%} else {%>
               <td class="DataTable44" id="tdGrp" rowspan=3>District <%=sReg[i]%></td>
           <%}%>
         <%if(sPeriod.substring(0, 3).equals("MTD")){%>
         ...
         <%}%>
           ...
           <td class="DataTable4" id="tdGrp"  rowspan=3 >District <%=sReg[i]%></td>
        </tr>
    ...
    <%if(sLevel.equals("S")) {%>
      <%for(int i=0; i < iNumOfReg; i++) {%>
        <tr class="DataTable1">
         ...
         <%if(sStore[0].length() >= 3 && sStore[0].substring(0, 3).equals("ALL")){%>
              <td class="DataTable6" id="tdGrp" rowspan=3  onClick="drillDown('RCS<%=sReg[i]%>')">District <%=sReg[i]%>(Cpmp Str)</td>
           <%} else {%>
               <td class="DataTable44" id="tdGrp" rowspan=3>District <%=sReg[i]%>(Cpmp Str)</td>
           <%}%>
         ...
         <%}%>
           ...
           <td class="DataTable4" id="tdGrp" rowspan=3 nowrap>District <%=sReg[i]%>(Comp Str)</td>
        </tr>
    ...
    <!------------------- Comp Store Totals -------------------------------------->
    <%if(sStore[0].length() > 1 && !sStore[0].equals("COMP") && !sStore[0].equals("COMPE") && sLevel.equals("S"))
    {
        for(int i=0; i < 2; i++)
        {
   ...
   <span>Note:  For comparison analysis, Sun & Ski Cash is not discounted to reduce Daily - 
        Flash Sales (viewed on this page).  However, on the <br>Sales Trend Comparison/Analysis - Total Retail Sales IS discounted by S&S Cash,
        so will always be lower than Flash Sales. </span>
        
   <%if(bToExcl){%>
   		<br><button onclick="flashToExcel()">To Excel</button>
   <%}%>     
    <!----------------------- end of table ---------------------------------->
    <p align="left">
    <%if ((sStore[0].equals("ALL") || sStore[0].equals("COMP")) && sDivision.equals("ALL")){%>
    ...
    <%if (sStore[0].equals("ALL") || sStore[0].equals("COMP")){%>
    ...
    <!-- Temerature -->
    <!-- =================================================================== -->
    <a class="blue" href="javascript: showTemp()">Temperature around Stores</a> &nbsp; &nbsp;
    <a class="blue" href="javascript: showTempSls()">fold/unfold sales%</a>
    <br>

    <table class="DataTable" id="tblTemp" cellPadding="0" cellSpacing="0">
        <tr class="TblHdr">
          <td class="DataTable313" rowspan="4">Str</td>
          <td class="DataTable313" colspan="6">Monday</td>
          <td class="DataTable313" colspan="6">Tuesday</td>
          <td class="DataTable313" colspan="6">Wednesday</td>
          <td class="DataTable313" colspan="6">Thursday</td>
          <td class="DataTable313" colspan="6">Friday</td>
          <td class="DataTable313" colspan="6">Saturday</td>
          <td class="DataTable313" colspan="6">Sunday</td>
          <td class="DataTable313" colspan="2">Week</td>
          <td class="DataTable313" rowspan="4">Str</td>
        </tr>
        <tr class="TblHdr">
          <%for(int i=0; i < 7; i++) {%><td class="DataTable31" colspan="3">TY</td><td class="DataTable313" colspan="3">LY</td><%}%>
          <td class="DataTable31" rowspan="2">TY</td><td class="DataTable313" rowspan="2">LY</td>
        </tr>
        <tr class="TblHdr">
          <%for(int i=0; i < 7; i++) {%>
             <td class="DataTable31" colspan="3"><%=sTyDate[i]%></td>
             <td class="DataTable313" colspan="3"><%=sLyDate[i]%></td><%}%>
        </tr>
        <tr class="TblHdr">
          <%for(int i=0; i < 7; i++) {%>
              <td class="DataTable3">Min</td><td class="DataTable3">Max</td><td class="DataTable31">Avg</td>
              <td class="DataTable3">Min</td><td class="DataTable3">Max</td><td class="DataTable313">Avg</td>
          <%}%>
        ...
        <%for(int i=0; i < iNumOfStr; i++) {%>
          <%if(!sTempStr[i].trim().equals("89")){
              int iVar = 0;
              String sTmpClr = "";
              if(!sTyTempAvg[i].trim().equals("") && !sLyTempAvg[i].trim().equals("") )
              {
                  int iTyAvg = Integer.parseInt(sTyTempAvg[i].trim());
                  int iLyAvg = Integer.parseInt(sLyTempAvg[i].trim());
                  iVar = iTyAvg - iLyAvg;
                  sTmpClr = "";
                  if(iVar > 10){sTmpClr = "R";}
                  else if(iVar > 5){sTmpClr = "P";}
                  else if(iVar < (-10)){sTmpClr = "B";}
                  else if(iVar < (-5)){sTmpClr = "G";}
              }
          %>
            <tr class="DataTable3" onmouseover="hiliTempTbl(this, true)" onmouseout="hiliTempTbl(this, false)">
               <td class="DataTable413" id="trTmpStr" rowspan=2>&nbsp;<%=sTempStr[i]%></td>
               <%for(int j=0; j < 7; j++) {%>
                 <td class="DataTable7<%=sDyTempClr[i][j]%>">&nbsp;<%=sTyTempMin[i][j]%></td>
                 <td class="DataTable71<%=sDyTempClr[i][j]%>">&nbsp;<%=sTyTempMax[i][j]%></td>
                 <td class="DataTable715<%=sDyTempClr[i][j]%>">&nbsp;<%=sTyDyTempAvg[i][j]%></td>
                 <td class="DataTable712<%=sDyTempClr[i][j]%>" >&nbsp;<%=sLyTempMin[i][j]%></td>
                 <td class="DataTable713<%=sDyTempClr[i][j]%>" >&nbsp;<%=sLyTempMax[i][j]%></td>
                 <td class="DataTable716<%=sDyTempClr[i][j]%>">&nbsp;<%=sLyDyTempAvg[i][j]%></td>
               <%}%>

               <td class="DataTable714<%=sTmpClr%>" style="color:black">&nbsp;<%=sTyTempAvg[i]%></td>
               <td class="DataTable716<%=sTmpClr%>" style="color:black">&nbsp;<%=sLyTempAvg[i]%></td>
               <td class="DataTable413" id="trTmpStr" rowspan=2>&nbsp;<%=sTempStr[i]%></td>
            </tr>

           <tr class="DataTable3" id="trTmpSlsPrc" onmouseover="hiliTempTbl(this, true)" onmouseout="hiliTempTbl(this, false)">
             <%for(int j=0; j < 7; j++) {%>
               <td class="DataTable715<%=sDyTempClr[i][j]%>" colspan=3>&nbsp;<%=sDlyPrc[i][j]%>%</td>
               <td class="DataTable716<%=sDyTempClr[i][j]%>" colspan=3>&nbsp;<%=sComPrc[i][j]%>%</td>
             <%}%>
               <td class="DataTable713">&nbsp;</td>
               <td class="DataTable716">&nbsp;</td>
           </tr>
          <%}%>
        <%}%>
        <!-- company Total -->
        <%
              int iVar = 0;
              String sTmpClr = "";
              if(!sTyTotTempAvg.trim().equals("") && !sLyTotTempAvg.trim().equals("") )
              {
                  int iTyAvg = Integer.parseInt(sTyTotTempAvg.trim());
                  int iLyAvg = Integer.parseInt(sLyTotTempAvg.trim());
                  iVar = iTyAvg - iLyAvg;
                  sTmpClr = "";
                  if(iVar > 10){sTmpClr = "R";}
                  else if(iVar > 5){sTmpClr = "P";}
        ...
        %>
        <tr class="DataTable2">
             <td class="DataTable413" id="trTmpStr" style="border-top: darkred solid 3px;" rowspan=2>Average</td>
             <%for(int i=0; i < 7; i++) {%>
               <td class="DataTable7<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sTyTotTempMin[i]%></td>
               <td class="DataTable71<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sTyTotTempMax[i]%></td>
               <td class="DataTable715<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sTyTotDyTempAvg[i]%></td>
               <td class="DataTable712<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sLyTotTempMin[i]%></td>
               <td class="DataTable713<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sLyTotTempMax[i]%></td>
               <td class="DataTable716<%=sDyTotTempClr[i]%>" style="border-top: darkred solid 3px;">&nbsp;<%=sLyTotDyTempAvg[i]%></td>
             <%}%>
             <td class="DataTable714<%=sTmpClr%>" style="color:black; border-top: darkred solid 3px;">&nbsp;<%=sTyTotTempAvg%></td>
             <td class="DataTable713<%=sTmpClr%>" style="color:black; border-top: darkred solid 3px;">&nbsp;<%=sLyTotTempAvg%></td>
             <td class="DataTable413" id="trTmpStr" style="border-top: darkred solid 3px;" rowspan=2>Average</td>
          </tr>
          <tr class="DataTable2" id="trTmpSlsPrc">
             <%for(int i=0; i < 7; i++) {%>
               <td class="DataTable715<%=sDyTotTempClr[i]%>" colspan=3>&nbsp;<%=sRepDlyPrc[i]%>%</td>
               <td class="DataTable716<%=sDyTotTempClr[i]%>" colspan=3>&nbsp;<%=sRepComPrc[i]%>%</td>
             <%}%>
          </tr>

          <tr class="DataTable2">
             <td class="DataTable413" style="border-top: darkred solid 3px;">LY Temp Rank</td>
             <%for(int i=0; i < 7; i++) {%>
               <td class="DataTable715" colspan=5>&nbsp;</td>
               <td class="DataTable716<%if(sLyTotDyAvgRank[i].equals("1")){%>B<%} else if(sLyTotDyAvgRank[i].equals("7")){%>R<%}%>">&nbsp;<%=sLyTotDyAvgRank[i]%></td>
             <%}%>
             <td class="DataTable413" style="border-top: darkred solid 3px;">Temp Rank</td>
          </tr>
      </table>
    ...
    <!-- =================================================================== -->
    <div id="dvEvtCal" class="dvEvtCal"></div>
    <!-- =================================================================== -->
  </table>  
  <br>  
...
<script>
   ...
   window.location.href = "FlashSalesSel.jsp";
</script>
<%}%>