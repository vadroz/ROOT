...
else
{
   ...
   //                   + "|" + sAction + "|" + sUser);
   //for(int i=0; i < sCol.length; i++)   { System.out.println(sCol[i]);  }

   EvtCalEnt evtcal = new EvtCalEnt(sEvent, sFrom, sTo, sScope, sRemind, sStrEvtTy, sEvtTime, sCol, sAction, sUser);
