...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PiReCntAreaSel.jsp&APPL=ALL");
   }
   else
   {
...
//==============================================================================
  ...
  var top = form.Top.value.trim();
  if(top == ""){error = true; msg += "\nPlease enter Top percentage"; }
  else if(isNaN(top)){error = true; msg += "\nTop percentage is not numeric."; }
  else if(eval(top) <= 0){error = true; msg += "\nTop percentage is not positive number."; }
...
<HTML><HEAD>
<title>PI Recount Area Sel</title>
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>PI Store Area Recount - Selection</B>
        <br><a href="/"><font color="red" size="-1">Home</font></a>

   <FORM  method="GET" action="PiReCntArea.jsp" onSubmit="return Validate(this)">
      <TABLE>
       <TBODY>
        <!-- =============================================================== -->
        <TR>
        ...
        <TR><TD style="border-bottom:darkred solid 1px" colspan="4" >&nbsp;</TD></TR>
        <TR>
          <TD class="Cell" nowrap>Top %:</td>
          <TD align=left>
           <input name="Top" value="5" maxlength=3 size=5>%          
          </td>
        </tr>
        <TR>
          <TD class="Cell" nowrap colspan=2>
