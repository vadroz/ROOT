<%@ page import="patiosales.WarrantyClaimSav,java.util.*, java.io.*"%>
<%
   ...
   if (session.getAttribute("USER")!=null)
   {
     ...
     if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        sOrder = sParam[1].trim();
        sClaim = sParam[2].trim();
        sItem = sParam[3].trim();
        ...
        sFileName = wcsave.addNewItmPicture(sOrder, sClaim, sItem , sExtension, "ADD_ITM_PICTURE", sUser);

        sFileOut = "C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/ROOT/Warranty_Claims/" + sFileName;
  ...
  String sUrl = "WarrantyClaimInfo.jsp?Order=" + sOrder + "&Claim=" + sClaim + "&Action=Update";
