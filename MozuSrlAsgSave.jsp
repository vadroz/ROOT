...
if  (session.getAttribute("USER")!=null)
{
   ...
   {
     System.out.println(sOrder + " " + sSku + " " + sSts + " " + sSrn[0] + " " + sUser + " " + sAction);
     ...
     if(!sRtvStr.equals(" "))
     {
    	 itmasgsav.saveRtv(sSite, sOrder, sSku, sStr, sEmp, sRtvStr, sUser);
     }
   }
   ...
   {
	   System.out.println(sSite + "|" + sOrder + "|" + sSku + "|" + sStr + "|" + sSrn[0]
		  + "|" + sEmp + "|" + sPackId + "|" + sAction + "|" + sUser);
	   ...
	   {   
		  System.out.println(sSite + "|" + sOrder + "|" + sStr + "|" + sEmp + "|" 
	        + sPackId + "|" + sUser);
