<%@ page import="ecommerce.EComCnlSum, rciutility.StoreSelect, java.util.*, java.text.*"%>
<%
...
{
     response.sendRedirect("SignOn1.jsp?TARGET=EComCnlSum.jsp&APPL=ALL&" + request.getQueryString());
}
else
{	
	...
	EComCnlSum cnlsum = new EComCnlSum();
...
{
	var url = "EComCnlSum.jsp?Sts=" + Sts + "&FromDt=" + FromDt + "&ToDt=" + ToDt + "&Sort=" + Sort;
	var lvl = Level;
...
{
	var url = "EComCnlSum.jsp?Sts=" + sts.value + "&FromDt=" + FromDt + "&ToDt=" + ToDt 
...
<!-------------------------------------------------------------------->
        ...
        <tr class="trHdr">
          <th colspan=45>
            ...
            <br>
              ...
              <a href="EComCnlSumSel.jsp"><font color="red" size="-1">Selection</font></a>&#62;
      ...
      <table class="tbl02">
        <tr class="trHdr01">
          ...
          <th class="th02" rowspan=3 >Qty</th>
          <th class="th02" rowspan=3 >Ret</th>
