<%@ page import="mozu_com.MozuOrdLst"%>
<%
    ...
    String sSiteSel = request.getParameter("Site");
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=MozuOrdLst.jsp");
}
{
    String sUser = session.getAttribute("USER").toString();
    MozuOrdLst ordLst = new MozuOrdLst(sSiteSel, sStatus, sOrdFrDate, sOrdToDate, sShpFrDate, sShpToDate, sSort, sUser);
...
<!-- ======================================================================= -->
       ...
       %>
         <tr class="DataTable<%=sLineClr%>">
            <td class="DataTable2" nowrap><a href="MozuOrdInfo.jsp?Site=<%=sSite%>&Order=<%=sOrd%>"><%=sOrd%></a></td>
