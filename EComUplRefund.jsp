<%@ page import="ecommerce.EComUplRefund"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplRefund.jsp");
}
else
{
    ...
    if (sAction.equals("UPLOAD"))
    {
       ...
       EComUplRefund uplprod = new EComUplRefund(sSite, sUser);
    }
%>
<HTML>
<HEAD>
...
function resubmit()
{
   ...
   var url = "EComUplRefund.jsp?Site=" + site
           + "&Action=UPLOAD";
   //alert(url);
...
{
  // return to main page
  window.location.href="EComUplRefund.jsp"
}
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - RMA (Refund) Uploading
        </B><br>
        Select Sites: &nbsp; &nbsp;
        ...
        <input class="Small" name="Site" type="radio" value="RACK">Total Car Rack &nbsp; &nbsp; &nbsp;
