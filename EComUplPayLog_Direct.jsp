...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplPayLog_Direct.jsp");
}
else
{
...
{
   if(NumOfErr == 0) { alert("Payment Log File Uploaded") }
   else { alert(Error) }
   parent.goToMainPage();
}
//==============================================================================
...
function resubmit()
{
   var url = "EComUplPayLog_Direct.jsp?&Action=UPLOAD";
...
{
  // return to main page
  window.location.href="EComUplPayLog_Direct.jsp"
}
//==============================================================================
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - Payment Log Uploading (Directly to ISP)
        </B><br>
