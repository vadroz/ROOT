<%@ page import="strforce.RtvCtlSv, java.text.*,java.util.*, java.io.*"%>
<%
   ...
   if (session.getAttribute("USER")!=null)
   {
     ...
     if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        sFileName = "SfSchedule.csv";
         
        sFileOut = "C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/ROOT/StoreForce/" + sFileName;
