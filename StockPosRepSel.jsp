...
<%
   ...
   else
   {
      ...
      // get fiscal calendar for today date
      ...
      // get division groups
      sPrepStmt = "select grpn, div from rci.DIVGRPS"
    	   + " order by GRPC, DIV";
   	  //System.out.println(sPrepStmt);
      rslset = null;
...
var MonNm = [ "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar" ];
var Month = "<%=sMonth%>";
var Year = "<%=sYear%>";
...
//==============================================================================
// populate select Month dropdown 
//==============================================================================
function setSelMon()
{
	var sel = document.getElementById("selMon");
	var mon = eval(Month) - 1;
	var yr = eval(Year);
	for(var i=0; i < 12 ;i++)
	{		
		if(i > 0 && MonNm[mon]=="Apr"){ yr++;}
		sel.options[i] = new Option(yr + " " + MonNm[mon], i+1);
		mon++;
		if(mon > 11){ mon = 0; }
	}
...
//store
  ...
  var sel = document.getElementById("selMon");
  var tomon = sel.options[sel.selectedIndex].value;

  if (error) alert(msg);
  else{ sbmSlsRep(divarr, dpt, cls, selstr, level, ucr, prec, tomon); }
  return error == false;
}
//==============================================================================
// Submit Stock Position Report
//==============================================================================
function sbmSlsRep(div, dpt, cls, str, level, ucr, prec, tomon)
{
  var url = null;
  url = "StockPosRep.jsp?"
  url += "&Dpt=" + dpt
...
<TABLE class="tbl05">
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Stock Position Report - Selection</B>
      ...
      <TABLE border=0>
        ...
        <TR><TD class="Cell2"  align=center  colspan=4><b><u>Calculate Stock Position through:</b></u></TD></tr>

        <TR>
          <TD class="Cell2"  align=center  colspan=4>
             <select name="selMon" id="selMon"></select>
          </TD>
        </TR>
        ...
        <TR>
          <TD class="Cell2"  align=center  colspan=4>
             ...
             <input name="Ucr" type="radio" value="C">Cost &nbsp; &nbsp;
             <input name="Ucr" type="radio" value="R" checked>Retail
          </TD>
        </TR>
