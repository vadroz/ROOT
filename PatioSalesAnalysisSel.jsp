...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PatioSalesAnalysisSel.jsp&APPL=ALL");
   }
   else
   {
%>
...
function sbmPlan(wkend)
{
  ...
  var url = "PatioSalesAnalysis.jsp?Wkend=" + wkend
  //alert(url)
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    ...
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Patio Furniture Sales Plus Open Orders - Selection</B>
