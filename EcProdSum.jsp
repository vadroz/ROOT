<!DOCTYPE html>	
<%@ page import="ecommerce.EcProdSum, java.util.*, java.text.*"%>
<%
...
{	
	...
	EcProdSum prodlst = new EcProdSum(sSrchDiv, sSrchDpt, sSrchCls, sSrchVen, sSeason, sReady
