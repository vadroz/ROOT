...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=CouponSumRepSel.jsp&APPL=ALL");
   }
   else
   {
...
<HTML>
<HEAD>
<title>Market Code Summary Selection</title>
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Market Code Summary - Selection</B>
        <br>
