...
function Validate()
{
  ...
  if (error) alert(msg);
  else{ sbmSlsRep(div, dpt, cls, str, wkend, level); }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmSlsRep(div, dpt, cls, str, wkend, level)
{
  var url = null;
  url = "FlashSlsGenderWtd.jsp?"
  url += "Str=" + str
      + "&Div=" + div
      + "&Dpt=" + dpt
      + "&Cls=" + cls
...
<TABLE class="tbl05">
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Flash Sales by Gender - Selection</B>
      ...
      <TABLE>
        ...
        <TR><TD class="Cell2"  align=center  colspan=4><b><u>Date selection:</b></u></TD></tr>
