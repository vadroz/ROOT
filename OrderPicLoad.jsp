...
<%
   ...
   if (session.getAttribute("USER")!=null)
   {
     ...
     if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        OrderEntry picsv = new OrderEntry();
        sFileName = picsv.addNewItmPicture(sOrder, sItem , sExtension, "ADD_ITM_PICTURE", sUser);

        sFileOut = "C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/ROOT/Patio_Furniture/" + sFileName;
  	...
  	String sUrl = "OrderEntry.jsp?Order=" + sOrder;
