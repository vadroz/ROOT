...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    ...
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
      ...
      <FORM  method="GET" action="servlet/unautmdreport.UnautMdRep01" onSubmit="return Validate(this)">
      <TABLE>
        <TBODY>
        <TR>
        ...
        <TR>
         ...
         <!-- ============================================================== -->
         <TR>
          <TD class=DataTable1 align=right>Sort By:</TD>
          <TD class=DataTable1 align=left>
             <SELECT name="SORT">
               <OPTION value="I">Division/Item</OPTION>
               <OPTION value="C">Store/Cashier</OPTION>
               <OPTION value="B">Store/Date</OPTION>
               <OPTION value="E">Store/Discount Amount</OPTION>
               <OPTION value="F">Store/Percentage off</OPTION>
               <OPTION value="A">Discount Amount</OPTION>
               <OPTION value="P">Percentage off</OPTION>
               <OPTION value="D">Discount Type</OPTION>
             </SELECT>
          </TD>
        </TR>
         <TR>
