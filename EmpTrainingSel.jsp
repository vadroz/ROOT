...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EmpTrainingSel.jsp&APPL=ALL&" + request.getQueryString());
}
else
{
...
function submitForm(){
   ...
   SbmString = "EmpTraining.jsp"
        + "?Store=" + selStore
        + "&StrName=" + selStoreName
        + "&TrnPgm=<%=sTrnPgm%>"
        + "&TrnPgmName=<%=sTrnPgmName%>";
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Select Store for <%=sTrnPgmName%> Employee Training<br>
