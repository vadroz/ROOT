...
{
   response.sendRedirect("SignOn1.jsp?TARGET=BdgSchActMn.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
...
{
  var fileType = "RCI";
  var url = 'BdgSchActWk.jsp?Store=<%=sStore%>&StrName=<%=sStrName%>&Wkend=' + wkend
...
function popActEmpGrpPanel()
{
  ...
  panel += "<tr class='DataTable2'>"
             ...
             + "<th class='DataTable3' colspan=6 nowrap>Average Rates</th>"
             + "<th class='DataTable3' rowspan=2 nowrap>&nbsp;</th>"
             + "<th class='DataTable3' colspan=6 rowspan=2 nowrap>Sales<br>Retail</th>"
         + "</tr>"
         + "<tr class='DataTable2'>"
             + "<th class='DataTable3' nowrap>Reg<br>Earn</th>"
...
function popGrpBdgAvgPanel()
{
  ...
  panel += "<tr class='DataTable2'>"
             + "<th class='DataTable3' rowspan=2 nowrap>Group</th>"
             + "<th class='DataTable3' colspan=7 nowrap>MTD Original Budget</th>"
             + "<th class='DataTable3' rowspan=2 nowrap>&nbsp</th>"
             + "<th class='DataTable3' colspan=7 nowrap>MTD Actual/Schedule</th>"
             + "<th class='DataTable3' rowspan=2 nowrap>&nbsp</th>"
             + "<th class='DataTable3' colspan=7 nowrap>MTD Variances</th>"
         + "</tr>"
         + "<tr class='DataTable2'>"
...
function popGrpBdgPayPanel()
{
  ...
  panel += "<tr class='DataTable2'>"
             ...
             + "<th class='DataTable3' colspan=7 nowrap>MTD Original Budget</th>"
             + "<th class='DataTable3' rowspan=2 nowrap>&nbsp</th>"
             + "<th class='DataTable3' colspan=8 nowrap>MTD Actual/Schedule</th>"
             + "<th class='DataTable3' rowspan=2 nowrap>&nbsp</th>"
             + "<th class='DataTable3' colspan=7 nowrap>MTD Variances</th>"
         + "</tr>"
         + "<tr class='DataTable2'>"
...
<!-------------------------------------------------------------------->
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Allowable Budget Review (Monthly) (OLD SCHEDULE PLATFORM - DO NOT USE AFTER 5/22/11)
...
<!-------------------------------------------------------------------->
      ...
      <table border=1 width="100%" cellPadding="0" cellSpacing="0">
        <tr>
          ...
          <%for(int i=0; i < iNumOfWk; i++){%>
             <th class="DataTable" rowspan=2 nowrap><a href="javascript: getWkBdgRep('<%=sWkend[i]%>');"><%=sWkend[i]%></a>
               <br><sup><i><%if(bSchApproved[i]){%>Approved<%}%></i></sup>
             </th>
          <%}%>
          <th class="DataTable" rowspan=2>Total Month</th>
          <th class="DataTable" rowspan=2>MTD<br><%if(iNumOfWkPass > 0) {%><%=sWkend[iNumOfWkPass-1]%><%}%></th>
          <th class="DataTable" colspan=<%=(iNumOfWkPass + 1)%>>Actual<br>Processed<br>Payroll</th>
        </tr>
        <tr>
           <%for(int i=0; i < iNumOfWkPass; i++){%>
              <th class="DataTable"><%=sWkend[i]%></th>
           <%}%>
           <th class="DataTable">MTD</th>
        </tr>
     ...
     <tr class="DataTable">
        ...
        <%}%>
        <td class="DataTable" colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>

     <!------------------- Alternate Sales Goal by Day % ---------------------->
     <tr class="Divdr1"><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="DataTable">
        ...
        <%}%>
        <td class="DataTable" rowspan=3 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">$<%=sAltSlsPlanDiff[i]%></td>
        <%}%>
     </tr>
     <!------------------------ Actual Sales  --------------------------------->
     <tr class="Divdr1"><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="DataTable">
        ...
        <%}%>
        <td class="DataTable" rowspan=2 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     ...
     <tr class="Divdr1"><td style="background: white;"><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;"><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;"><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     ...
     <tr class="DataTable1">
        ...
        <%}%>
        <td class="DataTable" style="background:white;" rowspan=6 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     <!-------------------------- Hours Earned -------------------------------->
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sHrsEarned[i]%><%}%></td>
        <%}%>
     </tr>
     <tr class="DataTable">
        <th class="DataTable11">Hours Earned (Based on Salaried Employees on V or H)</th>
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sSlrCredHrs[i]%><%}%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sHrsAllowed[i]%><%}%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <%if(!sAdjVar[i].equals("---")){%><td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sAdjVar[i]%><%}%></td>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <%if(!sBdgAdj[i].equals("---")){%><td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass){%><%=sBdgAdj[i]%><%}%></td>
           <%} else {%><td class="DataTable2">&nbsp;<%}%>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass ){%><%=sActPayHrs[i]%><%}%></td>
        <%}%>

        <%for(int i=0; i < iNumOfWkPass; i++){%>
           <td class="DataTable22"><%=sActPrcPayHrs[i]%></td>
        <%}%>
...
<!------------------------- Payroll Budget Dollars ----------------------->
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%>$<%=sPayAllowed[i]%><%}%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%>$<%=sActPayAmt[i]%><%}%></td>
        <%}%>
        <%for(int i=0; i < iNumOfWkPass; i++){%>
           <td class="DataTable22">$<%=sActPrcPayAmt[i]%></td>
        <%}%>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">$<%=sBdgAvg[i]%></td>
        <%}%>
        <td class="DataTable" colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     <!--------------- Allowable Average Hourly Rate ----------------->
     <tr class="DataTable">
        <th class="DataTable03">19</th>
        <th class="DataTable13">Allowable Budgeted Average Hourly Rate</th>
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%>$<%=sAlwHrRate[i]%><%}%></td>
        <%}%>
        <td class="DataTable" colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%>$<%=sActPayAvg[i]%><%}%></td>
        <%}%>
        <%for(int i=0; i < iNumOfWkPass; i++){%>
           <td class="DataTable22">$<%=sActPrcPayAvg[i]%></td>
        <%}%>
        <td class="DataTable22">$<%=sActPrcPayAvg[iNumOfCol-2]%></td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2<%if((i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass) && sHrsBdgVar[i].indexOf("-") >= 0){%>g<%} else if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass) {%>r<%}%>">&nbsp;
              <%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sHrsBdgVar[i]%><%}%></td>
        <%}%>
        <td class="DataTable" rowspan=5 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable2<%if((i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass) && sPayBdgVar[i].indexOf("-") >= 0){%>g<%} else if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass) {%>r<%}%>">&nbsp;
               <%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%>$<%=sPayBdgVar[i]%><%}%></td>
        <%}%>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable21">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sBdgPayOfSls[i]%>%<%}%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable21<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sWarnLine23[i]%><%}%>">&nbsp;<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sActPayOfSls[i]%>%<%}%></td>
        <%}%>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
           <td class="DataTable21<%if(i < iNumOfWkPass || i == iNumOfCol-1 || iNumOfWk == iNumOfWkPass){%><%=sWarnLine23[i]%><%}%>"><%=sAllowBdgActPrc[i]%>%</td>
        <%}%>
     </tr>

     <tr class="Divdr1"><td style="background: white;" colspan=2><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;" colspan=2><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;" colspan=2><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;" colspan=2><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     <tr class="Divdr1"><td style="background: white;" colspan=2><td colspan="<%=iNumOfCol + iNumOfWkPass + 3%>">&nbsp;</td></tr>
     ...
     <tr class="DataTable">
       <td class="DataTable" rowspan=4></td>
        <th class="DataTable26" rowspan=4>T/M/C</th>
        ...
        <%}%>
        <td class="DataTable" rowspan=4 colspan=<%=iNumOfWkPass + 1%>>&nbsp;</td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2"><%=sActTmcHrs[i]%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <th class="DataTable15">Hours Payrol $'s/Scheduled - TMC</th>
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2">$<%=sActTmcPay[i]%></td>
        <%}%>
     </tr>
