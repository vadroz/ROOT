...
<%
   ...
   if ( sStrAllowed != null && sStrAllowed.startsWith("ALL") || vStr != null && vStr.size() > 1) {
%>
...
function validate()
{
   ...
   url = "BaseSchedWkAdj.jsp?Wkend=" + wkend;
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Base Schedule Sales Threshold and Hourly Employee Hours Adjustments - Selection
       </b><br><br>
