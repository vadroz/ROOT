<%@ page import="ecommerce.EComUplCustEMail"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplCustEMail.jsp");
}
else
{
    ...
    {
       EComUplCustEMail uplprod = new EComUplCustEMail(sSite, sUser);
    }
%>
<HTML>
<HEAD>
...
{
   alert("Customer e-mail addresses were updated")
   parent.redisplay();
}
//==============================================================================
// re-submit
...
function resubmit()
{
   ...
   var url = "EComUplCustEMail.jsp?Site=" + site
           + "&Action=UPLOAD";
   //alert(url);
...
{
  // return to main page
  window.location.href="EComUplCustEMail.jsp"
}
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - Customer E-Mail Addresses Uploading
        </B><br>
        ...
        <input class="Small" name="Site" type="radio" value="RLHD">Railhead Board Sports
        <input class="Small" name="Site" type="radio" value="RACK">Total Car Rack<br>
