...
function Validate()
{
  ...
  if (error) alert(msg);
  else{ sbmPlan(sts, frdate, todate, selstr, sku, ctl, grp, type) }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmPlan(sts, frdate, todate, selstr, sku, ctl, grp, type)
{
  var url = null;
  url = "MosStrCtl.jsp?"
      + "From=" + frdate
      ...
      <TABLE>
        ...
        <tr>
            <TD class="Cell1" nowrap>
              ...
              <input class="Small" name="Sts" type="checkbox" value="Submitted" checked>Submitted &nbsp;
              <input class="Small" name="Sts" type="checkbox" value="Approved" checked>Approved &nbsp;
              <input class="Small" name="Sts" type="checkbox" value="Processed">Processed &nbsp;              
            </td>
        </TR>
        <!-- ============== Store List ========================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
        ...
        <TR>
          <TD id="tdDate1" colspan=4 align=center style="padding-top: 10px;" >
             <button id="btnSelDates" onclick="showDates(1,1)">Optional Date Selection</button>&nbsp;
        ...
        <!-- =============================================================== -->
          <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
          <TR>
              <TD class="Cell2" align=center colSpan=5>Select type of information</TD>
          </TR>
          <TR>
              <TD align=center colSpan=5>
