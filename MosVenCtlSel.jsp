...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=MosVenCtlSel.jsp&APPL=ALL");
   }
   else
   {
...
function Validate()
{
  ...
  var grp = "Ven";
  if(ven != "ALL" && numstr > 1){ grp = "Str"; }
  else if(numstr == 1){ grp = "Ctl"; }
  ...
  if (error) alert(msg);
  else{ sbmPlan(ven, sts, selstr, sku, ctl, grp, type
...
// Submit OTB Planning
//==============================================================================
function sbmPlan(ven, sts, selstr, sku, ctl, grp, type
		, wkend, wkend2, year, month, datelvl, defect)
{
  var url = null;
  url = "MosVenCtl.jsp?"
      ...
      <TABLE>
        ...
        <tr class="trDtl19">
            <TD class="td09" nowrap>
              ...
              <input class="Small" name="MosDef" type="radio" value="D">Defect &nbsp;
            </td>
        </TR>
        <!-- =============================================================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
        ...
        <tr class="trDtl19">
            <TD class="td09" nowrap>
              <input class="Small" name="Sts" type="checkbox" value="Open" >Open (not submitted) &nbsp;
              <input class="Small" name="Sts" type="checkbox" value="Submitted" checked>Submitted (not approved) &nbsp;
              <input class="Small" name="Sts" type="checkbox" value="Approved" >Approved by DM &nbsp;
              <input class="Small" name="Sts" type="checkbox" value="Processed">Processed out of Inventory &nbsp;             
            </td>
        </TR>
        <!-- ============== Store List ========================== -->
        <TR><TD style="border-bottom:darkred solid 1px" colspan="5" >&nbsp;</TD></TR>
