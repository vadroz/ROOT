...
//----------------------------------
String sAppl = "COORGOAL";
if (session.getAttribute("USER")==null || session.getAttribute(sAppl)==null
&& !session.getAttribute("APPLICATION").equals(sAppl))
{
   response.sendRedirect("SignOn1.jsp?TARGET=CoorGoalSel.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
%>
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Select Week & Coordinators Incentive Plans<br></b>
