...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=MozuShipOrdStsSel.jsp&APPL=ALL");
   }
   else
   {
...
function Validate()
{
  ...
  if (error) alert(msg);
  else{ sbmPlan(stsfrdate, ststodate, selstr) }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmPlan(stsfrdate, ststodate, selstr)
{
  var url = null;
  url = "MozuShipOrdSts.jsp?"
      + "FrDate=" + stsfrdate
      + "&ToDate=" + ststodate
  
  if(selstr.length == 1) { url += "&By=GRP";} else{url += "&By=STR";}    
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Mozu - Shipped Order Statistics - Selection</B>
