<%@ page import="payrollreports.PrSavSchedEnt, java.util.*"%>
<% // Get query string parameters
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PrSavSchedEnt.jsp&APPL=" + sAppl + "&" + request.getQueryString());
   }
   else
   {
     ...
     PrSavSchedEnt svScd = new PrSavSchedEnt();
     ...
     // redirect to topic list
      if(sDoc.equals("DAY")){
         ...
         sLink = "PrWkSched.jsp?STORE=" + sStore
                   + "&STRNAME=" + sThisStrName
                   + "&MONBEG=" + sMonth
                   + "&WEEKEND=" + sWeekEnd
                   + "&FROM=" + sFrom
