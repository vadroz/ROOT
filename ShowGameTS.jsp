     ...
     <!-------------------------------------------------------------------->
      ...
      <table class="DataTable" cellPadding="0" cellSpacing="0">
         ...
         <%int iPlr=0;
           ...
           <tr>
             <td class="DataTable3" ><%=sPlr1Lg[i]%></td>
             ...
             <td class="DataTable3" ><%=sPlr2Lg[i]%></td>
           ...
           <%for(int j=0; j < 4; j++ ){%>
             <tr>
                <td class="DataTable" colspan=2>&nbsp;<%if(j < sStr[iPlr].length){%>Store: <%=sStr[iPlr][j]%><%}%></td>
                <td class="DataTable1" >&nbsp;<%if(j < sStr[iPlr].length){%>$<%=sStrTySls[iPlr][j]%><%}%></td>
                <td class="DataTable1" >&nbsp;<%if(j < sStr[iPlr].length){%>$<%=sStrLySls[iPlr][j]%><%}%></td>
                <td class="DataTable1" >&nbsp;<%if(j < sStr[iPlr].length){%><%=sStrVar[iPlr][j]%>%<%}%></td>

                <th class="DataTable" >&nbsp;</th>

                <td class="DataTable" colspan=2>&nbsp;<%if(j < sStr[iPlr+1].length){%>Store: <%=sStr[iPlr+1][j]%><%}%></td>
                <td class="DataTable1" >&nbsp;<%if(j < sStr[iPlr+1].length){%>$<%=sStrTySls[iPlr+1][j]%><%}%></td>
                <td class="DataTable1" >&nbsp;<%if(j < sStr[iPlr+1].length){%>$<%=sStrLySls[iPlr+1][j]%><%}%></td>
                <td class="DataTable1" nowrap>&nbsp;<%if(j < sStr[iPlr+1].length){%><%=sStrVar[iPlr+1][j]%>%<%}%></td>
             </tr>
           <%}%>
           <%iPlr += 2;%>
           <!----------------- End Store Sales --------------------->
