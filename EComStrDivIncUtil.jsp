...
//==============================================================================
function setProfile(prof, qty, amt, action)
{
   	var hdr = "Add Profile";
...
function vldProfile(action)
{
	...
	else{ sbmProfile(prof, qty, amt,action); }
}
//==============================================================================
// submit Profile entry
//==============================================================================
function sbmProfile(prof, qty, amt, action)
{
       ...
       <table border=1 cellPadding="0" cellSpacing="0" id="tbRtvEnt">
         <tr class="DataTable">
             <th class="DataTable">Profile<br>
                <a class="small" href="javascript: setProfile(null,null,null,'Add');">New</a>
             </th>
