...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=StrPtyCashRepSel.jsp&APPL=" + sAppl);
   }
   else {
...
function  doSelDate()
{
  ...
  document.all.ToWkEnd.value = (date.getMonth()+1) + "/" + date.getDate() + "/" + date.getFullYear()
  document.all.FrWkEnd.value = (date.getMonth()+1) + "/" + date.getDate() + "/" + date.getFullYear()
}
//==============================================================================
// populate date with yesterdate
//==============================================================================
...
function validate()
{
   ...
   var frWkEnd = document.all.FrWkEnd.value
   var toWkEnd = document.all.ToWkEnd.value

   if (error) {alert(msg); }
   else { submit(frWkEnd, toWkEnd) }
}
//==============================================================================
// change action on submit
//==============================================================================
function submit(frWkEnd, toWkEnd){
   SbmString = "StrPtyCashRep.jsp"
        + "?FrWkEnd=" + frWkEnd
        + "&ToWkEnd=" + toWkEnd;
     ...
     <tr bgColor="moccasin">
      ...
      <TR>
          <TD align=right colspan=2><br>
           From Period Ending Date:&nbsp;
              <button class="Small" name="Down" onClick="setDate('DOWN', 'FrWkEnd')">&#60;</button>
              <input name="FrWkEnd" type="text" size=10 maxlength=10 readonly>
              <button class="Small" name="Up" onClick="setDate('UP', 'FrWkEnd')">&#62;</button>
              <a href="javascript:showCalendar(1, null, null, 800, 300, document.all.FrWkEnd)" >
              <img src="calendar.gif" alt="Calendar Prompt" width="34" height="21"></a>
          <br>
            To Period Ending Date (Wed - Tue):&nbsp;
              <button class="Small" name="Down" onClick="setDate('DOWN', 'ToWkEnd')">&#60;</button>
              <input name="ToWkEnd" type="text" size=10 maxlength=10 readonly>
              <button class="Small" name="Up" onClick="setDate('UP', 'ToWkEnd')">&#62;</button>
              <a href="javascript:showCalendar(1, null, null, 800, 300, document.all.ToWkEnd)" >
              <img src="calendar.gif" alt="Calendar Prompt" width="34" height="21"></a>
              <br><br>
          </TD>
      </TR>
