<%@ page import="ecommerce.EComItmSave , java.util.*"%>
<%
...
if  (session.getAttribute("USER")!=null && session.getAttribute("ECOMMERCE")!=null)
{
   ...
   itmsav = new EComItmSave(sCls, sVen, sSty, sClr, sSiz, sDesc, sCateg, sClrName, sSizName, sMnf,
              sModel, sMdlYear, sGender, sMap, sNoMap, sMapDt, sWeb, sCat, sSaS, sSChO, sSStp,
              sRebel, sRack, sJoJo, sCushn, sLive, sSavMNF, sTaxFree, sAction, session.getAttribute("USER").toString());
