<%@ page import="java.util.*, java.text.*, java.io.BufferedReader ,ecommerce.EComShopOrdLst, ecommerce.EComShopParseItems, ecommerce.EcShopCrtXmlFile"%>
<%@ page contentType="text/xml"%>
<%
    EComShopOrdLst shopord = new EComShopOrdLst();
    String sBatch = shopord.getBatch();

    System.out.println("Shopotron Order Request. Batch: " + sBatch);
