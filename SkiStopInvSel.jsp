...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=SkiStopInvSel.jsp&APPL=ALL");
   }
   else
   {
...
function Validate(excel)
{
  ...
  if (error) alert(msg);
  else{ sbmPlan(div, dpt, cls, ven, itmlevel, excel) }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmPlan(div, dpt, cls, ven, itmlevel, excel)
{
  var url = null;
  alert
  if (excel) { url = "SkiStopInvExl.jsp?" }
  else { url = "SkiStopInv.jsp?" }
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    ...
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Ski Stop Inventory - Selection</B>
      ...
      <TABLE>
        ...
        <TR>
           <TD class="Cell1"  colSpan=5>
              ...
              <input class="Small" name="ItmLevel" type="radio" value="DPT">By Department &nbsp;&nbsp;
              <input class="Small" name="ItmLevel" type="radio" value="CLS">By Class &nbsp;&nbsp;
