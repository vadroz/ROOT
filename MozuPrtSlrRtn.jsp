...
<%
   ...
   String [] sUps = request.getParameterValues("u");
   String [] sStr = request.getParameterValues("t");
   String [] sSrn = request.getParameterValues("v");
   String [] sReas = request.getParameterValues("r");
   String [] sDesc = request.getParameterValues("d");
...
{
     response.sendRedirect("SignOn1.jsp?TARGET=MozuPrtSrlRtn.jsp&APPL=ALL&" + request.getQueryString());
}
else
{	
	String sStmt = null;
    ...
    sStmt = "Select * from RCI.MOORDH where ohsite='" + sSite + "' and ohord=" + sOrd;            
	...
	if(rs.next())
	{
		...
		sBPhone = rs.getString("OhBPHome").trim();
		...
		sSPhone = rs.getString("OhSPHome").trim();
	}
%>
<html>
<head>
