...
var FixedHdrFtr = {hdr: ["#trTopHdr1", "#trTopHdr2"], footer:["#trFoot"] , bottom:["#trFoot1"]};
...
$(document).ready(function(){
	  ...
	  $("#trTopHdr1").mousedown(function(e){
...
<!-------------------------------------------------------------------->
      ...
      <!-- ======================================================================= -->
        ...
        <tr id="trFoot" style="background:gold">
             <td colspan =5>Total Line</td>
        </tr>    
<!------------------------------- Detail --------------------------------->
        ...
        while(orstsl.getNext()){
            ...
            <!-- ===== First SKU lane ========== -->            
      		...
      		%>
            	...
            	<td class="td06" nowrap rowspan="<%=iNumOfPack%>"> 
            	     ...
            	     else if(sRcv.equals("Y") && sRdy.equals("Y")){%><input onclick="markItem('<%=sSite%>','<%=sOrd%>', '<%=sPack%>','<%=sSku%>', '<%=sSrlN%>','Handled')" type="checkbox" value="Y"><%}%>
            	</td>
         ...
         <tfoot>
         <tr id="trFoot1" style="background:gold">
             <td colspan =5>Total Line</td>
         </tr>  
         </tfoot>       
         </table>
