<!DOCTYPE html>	
<%@ page import="ecommerce.EcShipOrdSts, java.util.*, java.text.*"%>
<%
...
{
     response.sendRedirect("SignOn1.jsp?TARGET=EcShipOrdSts.jsp&APPL=ALL&" + request.getQueryString());
}
else
{	
	String sUser = session.getAttribute("USER").toString();
	EcShipOrdSts shporsts = new EcShipOrdSts(sSelStr, sFrDate, sToDate, sBy, sSort, sUser);
        ...
        <tr class="trHdr">
          <th colspan=45>
            ...
            <br>
              ...
              <a href="EcShipOrdStsSel.jsp"><font color="red" size="-1">Selection</font></a>&#62;
