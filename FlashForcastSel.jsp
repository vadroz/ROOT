...
function Validate()
{
  ...
  var numwk = document.all.NumOfWk.options[document.all.NumOfWk.selectedIndex].value;
  ...
  if (error) alert(msg);
  else{ sbmSlsRep(div, dpt, cls, str, wkend, numwk, level); }
  return error == false;
}
//==============================================================================
// Submit OTB Planning
//==============================================================================
function sbmSlsRep(div, dpt, cls, str, wkend, numwk, level)
{
  var url = null;
  url = "FlashForcast.jsp?"
  url += "Str=" + str
      + "&Div=" + div
      + "&Dpt=" + dpt
      + "&Cls=" + cls
...
<TABLE class="tbl05">
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>Sales Forecasting Report - Selection</B>
      ...
      <TABLE>
        ...
        <TR><TD style="border-top:darkred solid 1px" colspan="4" >&nbsp;</TD></TR>
        <TR id="trWeek">
          <TD class="Cell">Start From Week: </TD>
          <TD class="Cell2">
          ...
          <TD class="Cell">Number of Week: </TD>
          <TD class="Cell2">
             <select name="NumOfWk" id="NumOfWk">
                <%for(int i=0; i < 12; i++){%> 
             		<option value="<%=i+1%>" <%if(i==3){%>selected<%}%>><%=i+1%></option>
             	<%}%>
             </select>
          </TD>
        </TR>
