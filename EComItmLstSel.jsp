  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle>
      ...
      <TABLE border=0>
        ...
        <TR>
            <TD colspan="4">
              ...
              <tr>
                ...
                <td class="Cell1">
                  <input class="Small" type="radio" name="InvAvl" value="70"> Warehouse 70 only<br>
                  <input class="Small" type="radio" name="InvAvl" value="1"> Warehouse 1 only<br>
                  <input class="Small" type="radio" name="InvAvl" value="BOTH"> Either 70 or 1<br>
        ...
        <tr>
            <TD class="Cell1" colspan=3>Parent: &nbsp;<input class="Small" name="Parent" size=13 maxlength=13></TD>
