...
<style>body {background:ivory;font-family: Verdanda}
        ...
        td.BoxName {cursor:move; background:lightblue
...
//==============================================================================
function showGrpBdg(arg)
{
	var hdr = "Payroll Dollars<br>Store: " + arg;
...
<!-------------------------------------------------------------------->
   ...
   <!-- details --> 
    <%for(int i=0; i < 50; i++){%>
      <tr class="DataTable">
      	<th class="DataTable3" width="5%"><%=i%></th>
      	<th class="DataTable3"><a href="javascript: showGrpBdg('<%=i%>')">B</a></th>
      </tr>
    <%} %>
