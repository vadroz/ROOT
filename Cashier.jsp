...
if (month > 2 && month < 8 || month == 2 && day >= 20) 
{
 ...
 <div id="dvInfo" class="Prompt" ></div>
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr>
      ...
      <form name="getStore" action="Cashier.jsp?<%=request.getQueryString()%>" method="POST">
      <table>
      <tr>
         <td>User:</td>
      ...
      <table border=0  width="70%"  cellPadding=0 cellSpacing=0>
        ...
        <tr>
      	...
      	<tr>
      		...
      		<td class="DataTable3" nowrap><a class="blue" href="https://workforcenow.adp.com/public/index.htm" target="_blank">
