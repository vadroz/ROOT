...
<% String sStore = request.getParameter("STORE");
   ...
   //System.out.println(sStore  + " | " + sDivision + " | " + sDepartment + " | " + sClass + " | " + sUCR );
   OpenToBuyEOY opnbuy = new OpenToBuyEOY(sStore, sDivision, sDepartment, sClass, sUCR, "N");
    ...
    String sBegYr = opnbuy.getBegYr();
    String sEndYr = opnbuy.getEndYr();
    ...
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr>
      <td ALIGN="center" VALIGN="TOP">
        ...
        <br>Open To Buy  - Plan A vs Plan B (<%=sByUCR%>)
        <br>Store: <%=sStore%>
...
<!-------------------------------------------------------------------->
      ...
      <table class="DataTable" cellPadding="0" cellSpacing="0">
        <tr>
          ...
          <th class="DataTable" colspan="3">EOM<br>Mar ' <%=sBegYr%></th>
          <th class="DataTable" rowspan="2">&nbsp;</th>
          <th class="DataTable" colspan="5">Sales Plan<br>Apr'<%=sBegYr%> - Mar'<%=sEndYr%></th>
          <th class="DataTable" rowspan="2">&nbsp;</th>
          <th class="DataTable" colspan="5">Markdown Of Sales<br>Apr'<%=sBegYr%> - Mar'<%=sEndYr%></th>
          <th class="DataTable" rowspan="2">&nbsp;</th>
          <th class="DataTable" colspan="3">EOM<br>Mar ' <%=sEndYr%></th>
          <th class="DataTable" rowspan="2">&nbsp;</th>
...
<!------------------------------- Data Detail --------------------------------->
           ...
           {
        	   String grpnm = sGrpName[i].replaceAll("'", "@#@");
           %>
              <tr class="DataTable">
              <%if(!sColName.equals("Class")) {%>
                  <td class="DataTable1" rowspan="1" nowrap><a href="javascript: drillDown('<%=sGrp[i]%>', '<%=sGrpName[i]%>', '<%=sColName%>')" class="blue"><%=sGrp[i] + " - " + sGrpName[i]%></a></td>
              <%}
                else  {%>
                  <td class="DataTable1" rowspan="1"  nowrap><%=sGrp[i] + " - " + sGrpName[i]%></td>
              <%}%>
                <th class="DataTable" rowspan="1"><a href="javascript: getOTBbyMonth('<%=sGrp[i]%>', '<%=grpnm%>', '<%=sColName%>')" class="blue">M</a></th>
                ...
                <td class="DataTable"><%=sActSls[i]%></td>
                <td class="DataTable"><%=sActSlsVar[i]%></td>
                <th class="DataTable" rowspan="1">&nbsp;</th>

                <td class="DataTable"><%=sMosA[i]%></td>
                <td class="DataTable"><%=sMosB[i]%></td>
                <td class="DataTable"><%=sMosVar[i]%></td>
                <td class="DataTable"><%=sActMkd[i]%></td>
                <td class="DataTable"><%=sActMkdVar[i]%></td>
                <th class="DataTable" rowspan="1">&nbsp;</th>
...
<!------------------- Company Total -------------------------------->
             <tr class="DataTable2">
                <td class="DataTable1" rowspan="1"><%=sTotal%></td>
                <th class="DataTable" rowspan="1">&nbsp;</th>
