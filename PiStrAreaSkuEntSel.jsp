...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PiStrAreaSkuEntSel.jsp&APPL=ALL");
   }
   else
   {
...
<TABLE height="100%" width="100%" border=0>
  ...
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>PI - Adjustment Correction Entry - Selection</B>
        <br><a href="/"><font color="red" size="-1">Home</font></a>

   <FORM  method="GET" action="PiStrAreaSkuEnt.jsp" onSubmit="return Validate(this)">
      <TABLE>
       <TBODY>
        <!-- =============================================================== -->
        <TR>
