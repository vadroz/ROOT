...
function validate()
{
   ...
   if(rangeType == "W")
   {
      if( str != "ALL" ) { url = "BdgSchActWk.jsp?Store=" + str + "&StrName=" + storeNames[strId] + "&Wkend=" + wkend; }
      else { url = "BdgSchActWkAllStr.jsp?Wkend=" + wkend; }
   }
   // monthly report
   else if(rangeType == "M")
   {
      if( str != "ALL" ) { url = "BdgSchActMn.jsp?Store=" + str + "&StrName=" + storeNames[strId] + "&Year=" + year + "&Month=" + monnum + "&MonName=" + monname; }
      else { url = "BdgSchActMonAllStr.jsp?Year=" + year + "&Month=" + monnum + "&MonName=" + monname; }
   }
   // quarterly report
   else if(rangeType == "Q")
   {
      if( str != "ALL" ) { url = "BdgSchActQtr.jsp?Store=" + str + "&StrName=" + storeNames[strId] + "&Year=" + year + "&Qtr=" + qtrnum; }
      else { url = "BdgSchActQtrAllStr.jsp?Year=" + year + "&Qtr=" + qtrnum; }
   }
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      <td ALIGN="center" VALIGN="TOP">
       ...
       <br>Allowable Budget vs. Schedule and Actual Payroll - Selection (OLD SCHEDULE PLATFORM - DO NOT USE AFTER 5/22/11)
       </b><br><br>
