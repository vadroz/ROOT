<%@ page import="java.util.*, java.text.*, payrollreports.BdgSchActQtr"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=BdgSchActQtr.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
   ...
   BdgSchActQtr bdgwk = new BdgSchActQtr(sStore, sYear, sQtr, sUser);
...
<!-------------------------------------------------------------------->
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Allowable Budget Review (Quarterly) (OLD SCHEDULE PLATFORM - DO NOT USE AFTER 5/22/11)
...
<!------------------------- Payroll Budget Dollars ----------------------->
     ...
     <tr class="DataTable">
       <td class="DataTable" rowspan=4></td>
        ...
        <%}%>
        <td class="DataTable" rowspan=4 colspan=<%=iNumOfWk%>>&nbsp;</td>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2" id="wk<%=iMonNum[i] + sMonEnd[i]%>"><%=sActTmcHrs[i]%></td>
        <%}%>
     </tr>
     ...
     <tr class="DataTable">
        ...
        <%for(int i=0; i < iNumOfCol; i++){%>
            <td class="DataTable2" id="wk<%=iMonNum[i] + sMonEnd[i]%>">$<%=sActTmcPay[i]%></td>
        <%}%>
     </tr>
