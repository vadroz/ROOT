...
<!-------------------------------------------------------------------->
   <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Monthly Budget vs. Schedule and Actual Payroll (OLD SCHEDULE PLATFORM - DO NOT USE AFTER 5/22/11)
     ...
     <%for(int i=0; i < iNumOfReg; i++){%>
        ...
        %>
            ...
            <td class="DataTable"><a href="BdgSchActMn.jsp?Store=<%=sStr[iStrNum]%>&Year=<%=sYear%>&Month=<%=sMonth%>&MonName=<%=sMonName%>" target="_blank"><%=sStr[iStrNum]%></a></td>
            <th class="DataTable">&nbsp;</th>
