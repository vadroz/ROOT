...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PsSchdConfSel.jsp");
   }
//==============================================================================
   else {
...
<!-------------------------------------------------------------------->
  ...
  <table border="0" width="100%" height="100%">
     ...
     <tr bgColor="moccasin">
      ...
      <tr>
        <td>Select Weekending:</td><td><SELECT class="small" name="WEEK">
            </SELECT></td>
      </tr>
      <tr>
         <td align="center" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <input class="small"  type="submit" value="Submit">&nbsp;&nbsp;&nbsp;&nbsp;
         <button  class="small" name="GetDate" onClick="getOldDate()">Prior Week Ending</button></td  >
      </tr>
      </table>
      </form>
                </td>
