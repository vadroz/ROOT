...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplKitLink_Direct.jsp");
}
else
{
...
{
   if(NumOfErr == 0) { alert("Kit Link File Uploaded") }
   else { alert(Error) }
   parent.goToMainPage();
}
//==============================================================================
...
function resubmit()
{
   var url = "EComUplKitLink_Direct.jsp?&Action=UPLOAD";
...
{
  // return to main page
  window.location.href="EComUplKitLink_Direct.jsp"
}
//==============================================================================
</script>
...
<TABLE height="100%" width="100%" border=0 id="tblSite">
  <TR bgColor=moccasin>
    <TD vAlign=top align=middle><B>Retail Concepts Inc.
        <BR>E-Commerce - Kit Link Uploading (Directly to ISP)
        </B><br>
