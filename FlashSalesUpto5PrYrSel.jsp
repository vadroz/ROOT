          ...
          <TD align=left>
             <table style="font-size:12px;" cellPadding=0 cellSpacing=0>
               ...
               <tr style="font-size:12px;">
                  ...
                  <td><input name="Report" type="radio" value="MTDTYLY2" checked>LLY</td>
                  <td><input name="Report" type="radio" value="MTDTYLY2A">2LY Avg.</td>

                  <th style="border-left:darkred 1px solid; border-right:darkred 1px solid">&nbsp;</th>

                  <td><input name="Report" type="radio" value="YTDTYLY"> LY</td>
                  <td><input name="Report" type="radio" value="YTDTYLY2">LLY</td>
                  <td><input name="Report" type="radio" value="YTDTYLY2A">2LY Avg.</td>

               <tr style="font-size:12px;">
                  <td><input name="Report" type="radio" value="MTDTYLY3A">3LY Avg.</td>
                  <td><input name="Report" type="radio" value="MTDTYLY4A">4LY Avg.</td>
                  <td><input name="Report" type="radio" value="MTDTYLY5A">5LY Avg.</td>

                  <th style="border-left:darkred 1px solid; border-right:darkred 1px solid">&nbsp;</th>

                  <td><input name="Report" type="radio" value="YTDTYLY3A">3LY Avg.</td>
                  <td><input name="Report" type="radio" value="YTDTYLY4A">4LY Avg.</td>
                  <td><input name="Report" type="radio" value="YTDTYLY5A">5LY Avg.</td>
               </tr>
