...
if (session.getAttribute("USER")!=null)
{
   ...
   String sStr = "";
      ...
      sStmt = "select digits(ecls) as ecls, digits(even) as even, digits(esty) as esty" 
       + ", digits(eclr) as eclr , digits(esiz) as esiz, eret,ecst, edisc, eqty" 
       ...
       + " where edai>='" + sFrDate + "'" 
       + " and edai <= '" + sToDate + "'" 
       + " and edisc <> 0 and etos not in('080', '80')";
       
       if(!sSelStr.equals("ALL")) { sStmt += " and eist=" + sSelStr; }
       else { sStmt += " and edsc = " + sSelCode; }
       ...
       sStmt += " order by eist, cdiv, ecls, esku ";  
   ...
   out.println("\t\t\t Store: " + sSelStr + "\t Discount Code: " + sSelCode + "\tFrom: " + sFrDate + "\tTo: " + sToDate);
