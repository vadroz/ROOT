<%@ page import="ecommerce.EComUplPayLog"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=EComUplPayLog.jsp");
}
else
{
    ...
    if (sAction.equals("UPLOAD"))
    {
       ...
       EComUplPayLog uplprod = new EComUplPayLog(sSite, sUser);
    }
%>
<HTML>
<HEAD>
...
function resubmit()
{
   ...
   var url = "EComUplPayLog.jsp?Site=" + site
           + "&Action=UPLOAD";
   //alert(url);
...
{
  // return to main page
  window.location.href="EComUplPayLog.jsp"
}
</script>
