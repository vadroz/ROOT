...
<%
   ...
   {
     response.sendRedirect("SignOn1.jsp?TARGET=PsWkMonBdgSchSel.jsp&APPL=" + sAppl);
   }
   else {
   ...
   if (sStrAllowed != null) {
     ...
     //System.out.println(sStrAllowed.startsWith("ALL"));
...
function doStrSelect(id) {
    ...
    if(StrAllowed != "ALL" && !RegMon) idy = 1;
...
function chgWkMon(option)
{
  if (option=="W")
  {
    ...
    document.getStore.STORE.disabled = true;
  }
  else
  {
    document.forms[0].FISMON.disabled=false;
    document.forms[0].WEEK.disabled=true;
    document.getStore.STORE.disabled = false;
  }
}
</SCRIPT>
          </head>
 <body  onload="bodyLoad();">
      ...
      <tr><td>Select Store:</td><td><SELECT name="STORE"></SELECT></td>
      <!-- ================================================================= -->
      <tr style="background:darkred; font-size:1px"><td colspan=2>&nbsp;</td></tr>
      <TR>
          <TD align=center colspan=2><br>
            <span style="<%if(!bAllowWeekly){%>display:none;<%}%>">
               <input type="radio" name="DatTyp" onclick="chgWkMon('W')" value="W" >Weekly &nbsp; &nbsp; &nbsp; &nbsp;
               <input type="radio" name="DatTyp" onclick="chgWkMon('M')" value="M" checked>Monthly &nbsp; &nbsp; &nbsp; &nbsp;
            </span>
             <br><br>
          </TD>
      </TR>
      ...
      <tr style="background:darkred; font-size:1px"><td colspan=2>&nbsp;</td></tr>
      <tr>
        <td>Select Fiscal Month:</td><td><SELECT name="FISMON"></SELECT></td>
      </tr>
      <tr>
        <td>Select Week:</td><td><SELECT name="WEEK"></SELECT></td>
      </tr>
      <!-- ================================================================= -->
      <tr>
