<%@ page import="rciutility.StoreSelect, java.util.*, java.text.*, payrollreports.PsActAvgVarCmp"%>
<%
...
{
   response.sendRedirect("SignOn1.jsp?TARGET=PsActAvgVarCmpByGrp.jsp&APPL=" + sAppl + "&" + request.getQueryString());
}
else
{
     ...
     PsActAvgVarCmp actvar = new PsActAvgVarCmp(sStore, sFrom, sTo, sUser);
...
<!-------------------------------------------------------------------->
    <table border="0" width="100%" cellPadding="0" cellSpacing="0">
     <tr bgColor="ivory">
      ...
      <br>Budget vs. Actual Variances for
      ...
      <a href="PsActAvgVarAllStr.jsp?Store=<%=sStore%>&From=<%=sFrom%>&To=<%=sTo%>">Bdg vs. Act - All Str</a>
<!-------------------------------------------------------------------->
      <!----------------- beginning of table ------------------------>
     ...
     <%
        ...
        int iSlr = 0;
        int iHrl = 1;
        String [] sSlrRow = new String[]{"1a", "1b", "1c", "1d"};
     ...
     %>
        ...
        <%if(!sSvBdgSec.equals(sSecBdg[i])){%>
            ...
            <%if(sSecBdgNm[i].equals("Salaried")){%>
                <tr class="DataTable2" id="thSecNm">
                  ...
                  <td class="DataTable11" colspan="62">Salaried (<a href="javascript:setSlrDisp()">fold/unfold</a>)</td>
                </tr>
            <%}
        ...
        <tr class="DataTable" id="trDtl<%if(sSecBdg[i].equals("1")){%>1<%} else{%>2<%}%>"  <%if(sSecBdg[i].equals("1")){%>style="display:none;"<%}%>>
          ...
          <td class="DataTable2<%if(!sSecBdg[i].equals("1")){%>p<%}%>">&nbsp;<%if(sSecBdg[i].equals("1")){%>$<%=sVaHrSlr%><%}%></td>
  ...
  <!--------------- Level Break on Section --------------------->
        ...
        <tr class="DataTable3">
          ...
          <td class="DataTable2<%=sColor%>" nowrap>&nbsp;$<%=sVaHrTotal%></td>
            ...
            <tr class="DataTable31">
              ...
              <!-- Average Wage -->
          <td class="DataTable2" id="tdBkpAvg" colspan=6 nowrap>&nbsp;</td>
          ...
          <!-- Total $'s -->
          <td class="DataTable2" id="tdBkpPay" colspan=6 nowrap>&nbsp;</td>
          <td class="DataTable2" nowrap>&nbsp;</td>
          <th class="DataTable" id="tdBkpPay">&nbsp;</th>
          ...
          <td class="DataTable2" colspan=8 nowrap>&nbsp;</td>
            </tr>
        <%}%>
     ...
     <tr class="DataTable5">
       ...
       <th class="DataTable"><a href="PsActAvgVarAllStr.jsp?Store=<%=sStore%>&From=<%=sFrom%>&To=<%=sTo%>">All</a></th>
       <td class="DataTable2" id="tdHrs" nowrap>&nbsp;<%=sBdgHrs%></td>
       <td class="DataTable2" id="tdHrs" nowrap>&nbsp;<%=sActHrs%></td>
       <td class="DataTable2" id="tdHrs" nowrap>&nbsp;<%=sVarHrs%></td>
       <th class="DataTable">&nbsp;</th>
   ...
   %>
     ...
     <tr style="border:none;">
        <td colspan=62 style="color:blue; background:gold; text-align:center;">
          Add Adjustments (to Hourly) from Allowable Budget
        </td>
     </tr>
     ...
     <tr class="DataTable5">
       ...
       <td class="DataTable2" nowrap>&nbsp;$<%=sVaHrAvg%></td>
       <td class="DataTable2" id="tdAlwBdg" nowrap>$<%=sOth1Var%></td>
       <td class="DataTable2" id="tdAlwBdg" nowrap>$<%=sOth2Var%></td>
    ...
    <!--tr class="DataTable5">
     ...
     <tr class="DataTable5">
       <th class="DataTable"><%=iHrl++%></th>
       <td class="DataTable11" nowrap>Hourly TMC<sup>(2)</sup></td>
       <th class="DataTable" id="tdAlwBdg">&nbsp;</th>
       <td class="DataTable2p" id="tdAlwBdg" nowrap>&nbsp;</td>
